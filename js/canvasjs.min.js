...
"="+(new Date).getTime()+"; "+z.ckDec(z.str.ckve)+l.toUTCString()+"; path=/;";localStorage.setItem("lclStg",JSON.stringify(m))}d=!1}if(d){d=20;var p=a.ctx;p.font="bold "+d+"px Calibri";var e=z.ckDec(z.str.tem),q=p.measureText(e).width;p.fillStyle=u?z.ckDec(z.str.mco):z.ckDec(z.str.mcw);p.fillRect(a.plotArea.x2-q-8,a.plotArea.y2-2.5*d-8,q+4,2.5*d+8);p.fillStyle=u?z.ckDec(z.str.mct):z.ckDec(z.str.mcr);p.fillText(e,a.plotArea.x2-q-4,a.plotArea.y2-2.5*d-2);d=14;p.font=d+"px Calibri";e=z.ckDec(z.str.ctm);
q=p.measureText(e).width;p.fillStyle=u?z.ckDec(z.str.mct):z.ckDec(z.str.mcr);p.fillText(e,a.plotArea.x2-q-4,a.plotArea.y2-2*d-4);e=z.ckDec(z.str.ltm);q=p.measureText(e).width;p.fillText(e,a.plotArea.x2-q-4,a.plotArea.y2-d-4)}}catch(r){}}})();M.prototype.setOptions=function(a,d){if(ca[this._defaultsKey]){var b=ca[this._defaultsKey],c;for(c in b)"publicProperties"!==c&&b.hasOwnProperty(c)&&(this[c]=a&&c in a?a[c]:d&&c in d?d[c]:b[c])}};M.prototype.get=function(a){var d=ca[this._defaultsKey];if("options"===
a)return this.options&&this.options._isPlaceholder?null:this.options;if(d.hasOwnProperty(a)||d.publicProperties&&d.publicProperties.hasOwnProperty(a))return this[a];window.console&&window.console.log('Property "'+a+"\" doesn't exist. Please check for typo.")};M.prototype.set=function(a,d,b){b="undefined"===typeof b?!0:b;var c=ca[this._defaultsKey];if("options"===a)this.createUserOptions(d);else if(c.hasOwnProperty(a)||c.publicProperties&&c.publicProperties.hasOwnProperty(a)&&"readWrite"===c.publicProperties[a])this.options._isPlaceholder&&
...
(this.options._oldOptions={});return this.options._oldOptions[a]?!0:!1};M.prototype.hasOptionChanged=function(a){if(!this.sessionVariables)throw"Session Variable Store not set";return this.sessionVariables[a]!==this.options[a]};M.prototype.addEventListener=function(a,d,b){a&&d&&(this._eventListeners[a]=this._eventListeners[a]||[],this._eventListeners[a].push({context:b||this,eventHandler:d}))};M.prototype.removeEventListener=function(a,d){if(a&&d&&this._eventListeners[a])for(var b=this._eventListeners[a],
c=0;c<b.length;c++)if(b[c].eventHandler===d){b[c].splice(c,1);break}};M.prototype.removeAllEventListeners=function(){this._eventListeners=[]};M.prototype.dispatchEvent=function(a,d,b){if(a&&this._eventListeners[a]){d=d||{};for(var c=this._eventListeners[a],f=0;f<c.length;f++)c[f].eventHandler.call(c[f].context,d)}"function"===typeof this[a]&&this[a].call(b||this.chart,d)};U(A,M);A.prototype._updateOptions=function(){var a=this;this.updateOption("width");this.updateOption("height");this.updateOption("dataPointWidth");
this.updateOption("dataPointMinWidth");this.updateOption("dataPointMaxWidth");this.updateOption("interactivityEnabled");this.updateOption("theme");this.updateOption("colorSet")&&(this._selectedColorSet="undefined"!==typeof ha[this.colorSet]?ha[this.colorSet]:ha.colorSet1);this.updateOption("backgroundColor");this.backgroundColor||(this.backgroundColor="rgba(0,0,0,0)");this.updateOption("culture");this._cultureInfo=new oa(this.options.culture);this.updateOption("animationEnabled");this.animationEnabled=
this.animationEnabled&&u;this.updateOption("animationDuration");this.updateOption("rangeChanging");this.updateOption("rangeChanged");this.updateOption("exportEnabled");this.updateOption("exportFileName");this.updateOption("zoomType");this.options.zoomEnabled?(this._zoomButton||(Y(this._zoomButton=document.createElement("button")),T(this,this._zoomButton,"pan"),this._toolBar.appendChild(this._zoomButton),K(this._zoomButton,"click",function(){a.zoomEnabled?(a.zoomEnabled=!1,a.panEnabled=!0,T(a,a._zoomButton,
"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,T(a,a._zoomButton,"pan"));a.render()})),this._resetButton||(Y(this._resetButton=document.createElement("button")),T(this,this._resetButton,"reset"),this._toolBar.appendChild(this._resetButton),K(this._resetButton,"click",function(){a.toolTip.hide();a.zoomEnabled||a.panEnabled?(a.zoomEnabled=!0,a.panEnabled=!1,T(a,a._zoomButton,"pan"),a._defaultCursor="default",a.overlaidCanvas.style.cursor=a._defaultCursor):(a.zoomEnabled=!1,a.panEnabled=!1);if(a.sessionVariables.axisX)for(var b=
...
if(a.sessionVariables.axisY2)for(b=0;b<a.sessionVariables.axisY2.length;b++)a.sessionVariables.axisY2[b].newViewportMinimum=null,a.sessionVariables.axisY2[b].newViewportMaximum=null;a.resetOverlayedCanvas();Y(a._zoomButton,a._resetButton);a._dispatchRangeEvent("rangeChanging","reset");a.render();a._dispatchRangeEvent("rangeChanged","reset")}),this.overlaidCanvas.style.cursor=a._defaultCursor),this.zoomEnabled||this.panEnabled||(this._zoomButton?(a._zoomButton.getAttribute("state")===a._cultureInfo.zoomText?
(this.panEnabled=!0,this.zoomEnabled=!1):(this.zoomEnabled=!0,this.panEnabled=!1),ta(a._zoomButton,a._resetButton)):(this.zoomEnabled=!0,this.panEnabled=!1))):this.panEnabled=this.zoomEnabled=!1;this._menuButton?this.exportEnabled?ta(this._menuButton):Y(this._menuButton):this.exportEnabled&&u&&(this._menuButton=document.createElement("button"),T(this,this._menuButton,"menu"),this._toolBar.appendChild(this._menuButton),K(this._menuButton,"click",function(){"none"!==a._dropdownMenu.style.display||a._dropDownCloseTime&&
500>=(new Date).getTime()-a._dropDownCloseTime.getTime()||(a._dropdownMenu.style.display="block",a._menuButton.blur(),a._dropdownMenu.focus())},!0));if(!this._dropdownMenu&&this.exportEnabled&&u){this._dropdownMenu=document.createElement("div");this._dropdownMenu.setAttribute("tabindex",-1);this._dropdownMenu.style.cssText="position: absolute; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 1px;top: 25px;min-width: 120px;outline: 0;border: 1px solid silver;font-size: 14px;font-family: Calibri, Verdana, sans-serif;padding: 5px 0px 5px 0px;text-align: left;background-color: #fff;line-height: 20px;box-shadow: 2px 2px 10px #888888;";
a._dropdownMenu.style.display="none";this._toolBar.appendChild(this._dropdownMenu);K(this._dropdownMenu,"blur",function(){Y(a._dropdownMenu);a._dropDownCloseTime=new Date},!0);var d=document.createElement("div");d.style.cssText="padding: 2px 15px 2px 10px";d.innerHTML=this._cultureInfo.printText;this._dropdownMenu.appendChild(d);K(d,"mouseover",function(){this.style.backgroundColor="#EEEEEE"},!0);K(d,"mouseout",function(){this.style.backgroundColor="transparent"},!0);K(d,"click",function(){a.print();
Y(a._dropdownMenu)},!0);d=document.createElement("div");d.style.cssText="padding: 2px 15px 2px 10px";d.innerHTML=this._cultureInfo.saveJPGText;this._dropdownMenu.appendChild(d);K(d,"mouseover",function(){this.style.backgroundColor="#EEEEEE"},!0);K(d,"mouseout",function(){this.style.backgroundColor="transparent"},!0);K(d,"click",function(){Ba(a.canvas,"jpeg",a.exportFileName);Y(a._dropdownMenu)},!0);d=document.createElement("div");d.style.cssText="padding: 2px 15px 2px 10px";d.innerHTML=this._cultureInfo.savePNGText;
this._dropdownMenu.appendChild(d);K(d,"mouseover",function(){this.style.backgroundColor="#EEEEEE"},!0);K(d,"mouseout",function(){this.style.backgroundColor="transparent"},!0);K(d,"click",function(){Ba(a.canvas,"png",a.exportFileName);Y(a._dropdownMenu)},!0)}"none"!==this._toolBar.style.display&&this._zoomButton&&(this.panEnabled?T(a,a._zoomButton,"zoom"):T(a,a._zoomButton,"pan"),a._resetButton.getAttribute("state")!==a._cultureInfo.resetText&&T(a,a._resetButton,"reset"));this.options.toolTip&&this.toolTip.options!==
this.options.toolTip&&(this.toolTip.options=this.options.toolTip);for(var b in this.toolTip.options)this.toolTip.options.hasOwnProperty(b)&&this.toolTip.updateOption(b)};A.prototype._updateSize=function(){var a=0,d=0;this.options.width?a=this.width:this.width=a=0<this.container.clientWidth?this.container.clientWidth:this.width;this.options.height?d=this.height:this.height=d=0<this.container.clientHeight?this.container.clientHeight:this.height;return this.canvas.width!==a*Q||this.canvas.height!==d*
Q?(ra(this.canvas,a,d),ra(this.overlaidCanvas,a,d),ra(this._eventManager.ghostCanvas,a,d),!0):!1};A.prototype._initialize=function(){this._animator?this._animator.cancelAllAnimations():this._animator=new Da(this);this.removeAllEventListeners();this.disableToolTip=!1;this._axes=[];this.pieDoughnutClickHandler=null;this.animationRequestId&&this.cancelRequestAnimFrame.call(window,this.animationRequestId);this._updateOptions();this.animatedRender=u&&this.animationEnabled&&0===this.renderCount;this._updateSize();
this.clearCanvas();this.ctx.beginPath();this.axisX=[];this.axisX2=[];this.axisY=[];this.axisY2=[];this._indexLabels=[];this._dataInRenderedOrder=[];this._events=[];this._eventManager&&this._eventManager.reset();this.plotInfo={axisPlacement:null,axisXValueType:null,plotTypes:[]};this.layoutManager=new ja(0,0,this.width,this.height,2);this.plotArea.layoutManager&&this.plotArea.layoutManager.reset();this.data=[];var a=0;if(this.options.data)for(var d=0;d<this.options.data.length;d++)if(a++,!this.options.data[d].type||
0<=A._supportedChartTypes.indexOf(this.options.data[d].type)){var b=new $(this,this.options.data[d],a-1,++this._eventManager.lastObjectId);null===b.name&&(b.name="DataSeries "+a);null===b.color?1<this.options.data.length?(b._colorSet=[this._selectedColorSet[b.index%this._selectedColorSet.length]],b.color=this._selectedColorSet[b.index%this._selectedColorSet.length]):b._colorSet="line"===b.type||"stepLine"===b.type||"spline"===b.type||"area"===b.type||"stepArea"===b.type||"splineArea"===b.type||"stackedArea"===
...
f='You cannot combine "'+b.type+'" with pie chart':null===this.plotInfo.axisPlacement&&(this.plotInfo.axisPlacement="xySwapped"):"none"==c&&("normal"===this.plotInfo.axisPlacement?f='You cannot combine "'+b.type+'" with line, area, column or bar chart':"xySwapped"===this.plotInfo.axisPlacement?f='You cannot combine "'+b.type+'" with bar chart':null===this.plotInfo.axisPlacement&&(this.plotInfo.axisPlacement="none"));if(f&&window.console){window.console.log(f);return}}z.fAWm&&z.fAWm(this);var g=this;
this.addEventListener("dataAnimationIterationEnd",function(){z.fNg&&z.fNg(g)});Sa(this);this._objectsInitialized=!0};A._supportedChartTypes=qa("line stepLine spline column area stepArea splineArea bar bubble scatter stackedColumn stackedColumn100 stackedBar stackedBar100 stackedArea stackedArea100 candlestick ohlc rangeColumn rangeBar rangeArea rangeSplineArea pie doughnut funnel".split(" "));A.prototype.render=function(a){a&&(this.options=a);this._initialize();var d=[];for(a=0;a<this.data.length;a++)if("normal"===
...
(this.zoomEnabled||this.panEnabled))for(a=0;a<this._axes.length;a++)if(null!==this._axes[a].viewportMinimum||null!==this._axes[a].viewportMaximum){b=!0;break}b?ta(this._zoomButton,this._resetButton):(Y(this._zoomButton,this._resetButton),this.options.zoomEnabled&&(this.zoomEnabled=!0,this.panEnabled=!1));this._processData();this.options.title&&(this.title=new ma(this,this.options.title),this.title.dockInsidePlotArea?d.push(this.title):this.title.render());if(this.options.subtitles)for(this.subtitles=
[],a=0;a<this.options.subtitles.length;a++)b=new va(this,this.options.subtitles[a]),this.subtitles.push(b),b.dockInsidePlotArea?d.push(b):b.render();this.legend=new wa(this,this.options.legend);for(a=0;a<this.data.length;a++)(this.data[a].showInLegend||"pie"===this.data[a].type||"doughnut"===this.data[a].type)&&this.legend.dataSeries.push(this.data[a]);this.legend.dockInsidePlotArea?d.push(this.legend):this.legend.render();if("normal"===this.plotInfo.axisPlacement||"xySwapped"===this.plotInfo.axisPlacement)B.setLayoutAndRender(this.axisX,
this.axisX2,this.axisY,this.axisY2,this.plotInfo.axisPlacement,this.layoutManager.getFreeSpace());else if("none"===this.plotInfo.axisPlacement)this.preparePlotArea();else return;for(a=0;a<d.length;a++)d[a].render();var c=[];if(this.animatedRender){var f=ga(this.width,this.height);f.getContext("2d").drawImage(this.canvas,0,0,this.width,this.height)}for(a=0;a<this.plotInfo.plotTypes.length;a++)for(var d=this.plotInfo.plotTypes[a],g=0;g<d.plotUnits.length;g++){var h=d.plotUnits[g],l=null;h.targetCanvas=
null;this.animatedRender&&(h.targetCanvas=ga(this.width,this.height),h.targetCanvasCtx=h.targetCanvas.getContext("2d"));"line"===h.type?l=this.renderLine(h):"stepLine"===h.type?l=this.renderStepLine(h):"spline"===h.type?l=this.renderSpline(h):"column"===h.type?l=this.renderColumn(h):"bar"===h.type?l=this.renderBar(h):"area"===h.type?l=this.renderArea(h):"stepArea"===h.type?l=this.renderStepArea(h):"splineArea"===h.type?l=this.renderSplineArea(h):"stackedColumn"===h.type?l=this.renderStackedColumn(h):
...
this.data[a.dataSeriesIndexes[n]],p=0,e=!1,q=!1,r;if("normal"===m.axisPlacement||"xySwapped"===m.axisPlacement)var s=this.sessionVariables.axisX.newViewportMinimum?this.sessionVariables.axisX.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,v=this.sessionVariables.axisX.newViewportMaximum?this.sessionVariables.axisX.newViewportMaximum:this.options.axisX&&
this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(m.dataPoints[p].x&&m.dataPoints[p].x.getTime||"dateTime"===m.xValueType)g=!0;for(p=0;p<m.dataPoints.length;p++){"undefined"===typeof m.dataPoints[p].x&&(m.dataPoints[p].x=p+(a.axisX.logarithmic?1:0));m.dataPoints[p].x.getTime?(g=!0,c=m.dataPoints[p].x.getTime()):c=m.dataPoints[p].x;x(m.dataPoints[p].y)?f=0:(f=m.dataPoints[p].y,0===n&&(k=Math.min(f,
k)));c<b.min&&(b.min=c);c>b.max&&(b.max=c);if(0<p){if(a.axisX.logarithmic){var w=c/m.dataPoints[p-1].x;1>w&&(w=1/w);b.minDiff>w&&1!==w&&(b.minDiff=w)}else w=c-m.dataPoints[p-1].x,0>w&&(w*=-1),b.minDiff>w&&0!==w&&(b.minDiff=w);null!==f&&null!==m.dataPoints[p-1].y&&(a.axisY.logarithmic?0<f&&(w=f/m.dataPoints[p-1].y,1>w&&(w=1/w),d.minDiff>w&&1!==w&&(d.minDiff=w)):(w=f-m.dataPoints[p-1].y,0>w&&(w*=-1),d.minDiff>w&&0!==w&&(d.minDiff=w)))}if(c<s&&!e)null!==m.dataPoints[p].y&&(r=c);else{if(!e&&(e=!0,0<p)){p-=
2;continue}if(c>v&&!q)q=!0;else if(c>v&&q)continue;m.dataPoints[p].label&&(a.axisX.labels[c]=m.dataPoints[p].label);c<b.viewPortMin&&(b.viewPortMin=c);c>b.viewPortMax&&(b.viewPortMax=c);null===m.dataPoints[p].y?b.viewPortMin===c&&r<c&&(b.viewPortMin=r):(a.yTotals[c]=(a.yTotals[c]?a.yTotals[c]:0)+Math.abs(f),0<=f?h[c]=h[c]?h[c]+f:f:l[c]=l[c]?l[c]+f:f)}}this.plotInfo.axisXValueType=m.xValueType=g?"dateTime":"number"}for(p in h)h.hasOwnProperty(p)&&!isNaN(p)&&(a=h[p],a<d.min&&(d.min=Math.min(a,k)),a>
d.max&&(d.max=a),p<b.viewPortMin||p>b.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=Math.min(a,k)),a>d.viewPortMax&&(d.viewPortMax=a)));for(p in l)l.hasOwnProperty(p)&&!isNaN(p)&&(a=l[p],a<d.min&&(d.min=Math.min(a,k)),a>d.max&&(d.max=a),p<b.viewPortMin||p>b.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=Math.min(a,k)),a>d.viewPortMax&&(d.viewPortMax=a)))}};A.prototype._processStacked100PlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,b=a.axisX.dataInfo,
c,f,g=!1,h=!1,l=!1,k=[],n=0;n<a.dataSeriesIndexes.length;n++){var m=this.data[a.dataSeriesIndexes[n]],p=0,e=!1,q=!1,r;if("normal"===m.axisPlacement||"xySwapped"===m.axisPlacement)var s=this.sessionVariables.axisX.newViewportMinimum?this.sessionVariables.axisX.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,v=this.sessionVariables.axisX.newViewportMaximum?
this.sessionVariables.axisX.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(m.dataPoints[p].x&&m.dataPoints[p].x.getTime||"dateTime"===m.xValueType)g=!0;for(p=0;p<m.dataPoints.length;p++){"undefined"===typeof m.dataPoints[p].x&&(m.dataPoints[p].x=p+(a.axisX.logarithmic?1:0));m.dataPoints[p].x.getTime?(g=!0,c=m.dataPoints[p].x.getTime()):c=m.dataPoints[p].x;
f=x(m.dataPoints[p].y)?null:m.dataPoints[p].y;c<b.min&&(b.min=c);c>b.max&&(b.max=c);if(0<p){if(a.axisX.logarithmic){var w=c/m.dataPoints[p-1].x;1>w&&(w=1/w);b.minDiff>w&&1!==w&&(b.minDiff=w)}else w=c-m.dataPoints[p-1].x,0>w&&(w*=-1),b.minDiff>w&&0!==w&&(b.minDiff=w);x(f)||null===m.dataPoints[p-1].y||(a.axisY.logarithmic?0<f&&(w=f/m.dataPoints[p-1].y,1>w&&(w=1/w),d.minDiff>w&&1!==w&&(d.minDiff=w)):(w=f-m.dataPoints[p-1].y,0>w&&(w*=-1),d.minDiff>w&&0!==w&&(d.minDiff=w)))}if(c<s&&!e)null!==f&&(r=c);
else{if(!e&&(e=!0,0<p)){p-=2;continue}if(c>v&&!q)q=!0;else if(c>v&&q)continue;m.dataPoints[p].label&&(a.axisX.labels[c]=m.dataPoints[p].label);c<b.viewPortMin&&(b.viewPortMin=c);c>b.viewPortMax&&(b.viewPortMax=c);null===f?b.viewPortMin===c&&r<c&&(b.viewPortMin=r):(a.yTotals[c]=(a.yTotals[c]?a.yTotals[c]:0)+Math.abs(f),0<=f?h=!0:0>f&&(l=!0),k[c]=k[c]?k[c]+Math.abs(f):Math.abs(f))}}this.plotInfo.axisXValueType=m.xValueType=g?"dateTime":"number"}a.axisY.logarithmic?(d.max=x(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,
-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=x(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):h&&!l?(d.max=x(d.viewPortMax)?99:Math.max(d.viewPortMax,99),d.min=x(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):h&&l?(d.max=x(d.viewPortMax)?99:Math.max(d.viewPortMax,99),d.min=x(d.viewPortMin)?-99:Math.min(d.viewPortMin,-99)):!h&&l&&(d.max=x(d.viewPortMax)?-1:Math.max(d.viewPortMax,-1),d.min=x(d.viewPortMin)?-99:Math.min(d.viewPortMin,-99));d.viewPortMin=d.min;d.viewPortMax=
d.max;a.dataPointYSums=k}};A.prototype._processMultiYPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,b=a.axisX.dataInfo,c,f,g,h,l=!1,k=0;k<a.dataSeriesIndexes.length;k++){var n=this.data[a.dataSeriesIndexes[k]],m=0,p=!1,e=!1,q,r,s;if("normal"===n.axisPlacement||"xySwapped"===n.axisPlacement)var v=this.sessionVariables.axisX.newViewportMinimum?this.sessionVariables.axisX.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?
this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,w=this.sessionVariables.axisX.newViewportMaximum?this.sessionVariables.axisX.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(n.dataPoints[m].x&&n.dataPoints[m].x.getTime||"dateTime"===n.xValueType)l=!0;for(m=0;m<n.dataPoints.length;m++){"undefined"===
typeof n.dataPoints[m].x&&(n.dataPoints[m].x=m+(a.axisX.logarithmic?1:0));n.dataPoints[m].x.getTime?(l=!0,c=n.dataPoints[m].x.getTime()):c=n.dataPoints[m].x;if((f=n.dataPoints[m].y)&&f.length){g=Math.min.apply(null,f);h=Math.max.apply(null,f);r=!0;for(var y=0;y<f.length;y++)null===f.k&&(r=!1);r&&(p||(s=q),q=c)}c<b.min&&(b.min=c);c>b.max&&(b.max=c);g<d.min&&(d.min=g);h>d.max&&(d.max=h);0<m&&(a.axisX.logarithmic?(r=c/n.dataPoints[m-1].x,1>r&&(r=1/r),b.minDiff>r&&1!==r&&(b.minDiff=r)):(r=c-n.dataPoints[m-
1].x,0>r&&(r*=-1),b.minDiff>r&&0!==r&&(b.minDiff=r)),f&&(null!==f[0]&&n.dataPoints[m-1].y&&null!==n.dataPoints[m-1].y[0])&&(a.axisY.logarithmic?(r=f[0]/n.dataPoints[m-1].y[0],1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=f[0]-n.dataPoints[m-1].y[0],0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r))));if(!(c<v)||p){if(!p&&(p=!0,0<m)){m-=2;q=s;continue}if(c>w&&!e)e=!0;else if(c>w&&e)continue;n.dataPoints[m].label&&(a.axisX.labels[c]=n.dataPoints[m].label);c<b.viewPortMin&&(b.viewPortMin=c);c>b.viewPortMax&&
(b.viewPortMax=c);if(b.viewPortMin===c&&f)for(y=0;y<f.length;y++)if(null===f[y]&&q<c){b.viewPortMin=q;break}null===f?b.viewPortMin===c&&q<c&&(b.viewPortMin=q):(g<d.viewPortMin&&(d.viewPortMin=g),h>d.viewPortMax&&(d.viewPortMax=h))}}this.plotInfo.axisXValueType=n.xValueType=l?"dateTime":"number"}};A.prototype.getDataPointAtXY=function(a,d,b){b=b||!1;for(var c=[],f=this._dataInRenderedOrder.length-1;0<=f;f--){var g=null;(g=this._dataInRenderedOrder[f].getDataPointAtXY(a,d,b))&&c.push(g)}a=null;d=!1;
for(b=0;b<c.length;b++)if("line"===c[b].dataSeries.type||"stepLine"===c[b].dataSeries.type||"area"===c[b].dataSeries.type||"stepArea"===c[b].dataSeries.type)if(f=L("markerSize",c[b].dataPoint,c[b].dataSeries)||8,c[b].distance<=f/2){d=!0;break}for(b=0;b<c.length;b++)d&&"line"!==c[b].dataSeries.type&&"stepLine"!==c[b].dataSeries.type&&"area"!==c[b].dataSeries.type&&"stepArea"!==c[b].dataSeries.type||(a?c[b].distance<=a.distance&&(a=c[b]):a=c[b]);return a};A.prototype.getObjectAtXY=function(a,d,b){var c=
...
function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))};A.prototype.attachEvent=function(a){this._events.push(a)};A.prototype._touchEventHandler=function(a){if(a.changedTouches&&this.interactivityEnabled){var d=[],b=a.changedTouches,c=b?b[0]:a,f=null;switch(a.type){case "touchstart":case "MSPointerDown":d=["mousemove","mousedown"];this._lastTouchData=xa(c);this._lastTouchData.time=new Date;
break;case "touchmove":case "MSPointerMove":d=["mousemove"];break;case "touchend":case "MSPointerUp":d="touchstart"===this._lastTouchEventType||"MSPointerDown"===this._lastTouchEventType?["mouseup","click"]:["mouseup"];break;default:return}if(!(b&&1<b.length)){f=xa(c);f.time=new Date;try{var g=f.y-this._lastTouchData.y,h=f.time-this._lastTouchData.time;if(15<Math.abs(g)&&(this._lastTouchData.scroll||200>h)){this._lastTouchData.scroll=!0;var l=window.parent||window;l&&l.scrollBy&&l.scrollBy(0,-g)}}catch(k){}this._lastTouchEventType=
a.type;if(this._lastTouchData.scroll&&this.zoomEnabled)this.isDrag&&this.resetOverlayedCanvas(),this.isDrag=!1;else for(b=0;b<d.length;b++)f=d[b],g=document.createEvent("MouseEvent"),g.initMouseEvent(f,!0,!0,window,1,c.screenX,c.screenY,c.clientX,c.clientY,!1,!1,!1,!1,0,null),c.target.dispatchEvent(g),a.preventManipulation&&a.preventManipulation(),a.preventDefault&&a.preventDefault()}}};A.prototype._dispatchRangeEvent=function(a,d){var b={chart:this};b.type=a;b.trigger=d;var c=[];this.axisX&&0<this.axisX.length&&
c.push("axisX");this.axisX2&&0<this.axisX2.length&&c.push("axisX2");this.axisY&&0<this.axisY.length&&c.push("axisY");this.axisY2&&0<this.axisY2.length&&c.push("axisY2");for(var f=0;f<c.length;f++)if(x(b[c[f]])&&(b[c[f]]=[]),"axisY"===c[f])for(var g=0;g<this.axisY.length;g++)b[c[f]].push({viewportMinimum:this[c[f]][g].sessionVariables.newViewportMinimum,viewportMaximum:this[c[f]][g].sessionVariables.newViewportMaximum});else if("axisY2"===c[f])for(g=0;g<this.axisY2.length;g++)b[c[f]].push({viewportMinimum:this[c[f]][g].sessionVariables.newViewportMinimum,
...
a.target===c.chart.overlaidCanvas&&c[b].call(c.context,d.x,d.y):a.target!==c.chart.overlaidCanvas&&(c.chart.isDrag=!1)));if(this.interactivityEnabled)if(this._ignoreNextEvent)this._ignoreNextEvent=!1;else if(a.preventManipulation&&a.preventManipulation(),a.preventDefault&&a.preventDefault(),!f){if(!A.capturedEventParam&&this._events){for(var g=0;g<this._events.length;g++)if(this._events[g].hasOwnProperty(b))if(c=this._events[g],f=c.bounds,d.x>=f.x1&&d.x<=f.x2&&d.y>=f.y1&&d.y<=f.y2){c[b].call(c.context,
d.x,d.y);"mousedown"===b&&!0===c.capture?(A.capturedEventParam=c,this.overlaidCanvas.setCapture?this.overlaidCanvas.setCapture():document.documentElement.addEventListener("mouseup",this._mouseEventHandler,!1)):"mouseup"===b&&(c.chart.overlaidCanvas.releaseCapture?c.chart.overlaidCanvas.releaseCapture():document.documentElement.removeEventListener("mouseup",this._mouseEventHandler,!1));break}else c=null;a.target.style.cursor=c&&c.cursor?c.cursor:this._defaultCursor}b=this.plotArea;if(d.x<b.x1||d.x>
b.x2||d.y<b.y1||d.y>b.y2)this.toolTip&&this.toolTip.enabled?this.toolTip.hide():this.resetOverlayedCanvas();this.isDrag&&this.zoomEnabled||!this._eventManager||this._eventManager.mouseEventHandler(a)}};A.prototype._plotAreaMouseDown=function(a,d){this.isDrag=!0;this.dragStartPoint={x:a,y:d}};A.prototype._plotAreaMouseUp=function(a,d){if(("normal"===this.plotInfo.axisPlacement||"xySwapped"===this.plotInfo.axisPlacement)&&this.isDrag){var b=d-this.dragStartPoint.y,c=a-this.dragStartPoint.x,f=0<=this.zoomType.indexOf("x"),
...
b=f?this.dragStartPoint.x:this.plotArea.x1;c=g?this.dragStartPoint.y:this.plotArea.y1;f=f?a:this.plotArea.x2;g=g?d:this.plotArea.y2;2<Math.abs(b-f)&&2<Math.abs(c-g)&&this._zoomPanToSelectedRegion(b,c,f,g)&&(h=!0)}h&&(this._ignoreNextEvent=!0,this._dispatchRangeEvent("rangeChanging","zoom"),this.render(),this._dispatchRangeEvent("rangeChanged","zoom"),h&&(this.zoomEnabled&&"none"===this._zoomButton.style.display)&&(ta(this._zoomButton,this._resetButton),T(this,this._zoomButton,"pan"),T(this,this._resetButton,
"reset")))}}this.isDrag=!1};A.prototype._plotAreaMouseMove=function(a,d){if(this.isDrag&&"none"!==this.plotInfo.axisPlacement){var b=0,c=0,f=b=null,f=0<=this.zoomType.indexOf("x"),g=0<=this.zoomType.indexOf("y"),h=this;"xySwapped"===this.plotInfo.axisPlacement&&(b=g,g=f,f=b);b=this.dragStartPoint.x-a;c=this.dragStartPoint.y-d;2<Math.abs(b)&&8>Math.abs(b)&&(this.panEnabled||this.zoomEnabled)?this.toolTip.hide():this.panEnabled||this.zoomEnabled||this.toolTip.mouseMoveHandler(a,d);if((!f||2<Math.abs(b)||
!g||2<Math.abs(c))&&(this.panEnabled||this.zoomEnabled))if(this.panEnabled)f={x1:f?this.plotArea.x1+b:this.plotArea.x1,y1:g?this.plotArea.y1+c:this.plotArea.y1,x2:f?this.plotArea.x2+b:this.plotArea.x2,y2:g?this.plotArea.y2+c:this.plotArea.y2},clearTimeout(h._panTimerId),h._panTimerId=setTimeout(function(b,c,e,f){return function(){h._zoomPanToSelectedRegion(b,c,e,f,!0)&&(h._dispatchRangeEvent("rangeChanging","pan"),h.render(),h._dispatchRangeEvent("rangeChanged","pan"),h.dragStartPoint.x=a,h.dragStartPoint.y=
d)}}(f.x1,f.y1,f.x2,f.y2),0);else if(this.zoomEnabled){this.resetOverlayedCanvas();b=this.overlaidCanvasCtx.globalAlpha;this.overlaidCanvasCtx.fillStyle="#A89896";var c=f?this.dragStartPoint.x:this.plotArea.x1,l=g?this.dragStartPoint.y:this.plotArea.y1,k=f?a-this.dragStartPoint.x:this.plotArea.x2-this.plotArea.x1,n=g?d-this.dragStartPoint.y:this.plotArea.y2-this.plotArea.y1;this.validateRegion(c,l,f?a:this.plotArea.x2-this.plotArea.x1,g?d:this.plotArea.y2-this.plotArea.y1,"xy"!==this.zoomType).isValid&&
(this.resetOverlayedCanvas(),this.overlaidCanvasCtx.fillStyle="#99B2B5");this.overlaidCanvasCtx.globalAlpha=0.7;this.overlaidCanvasCtx.fillRect(c,l,k,n);this.overlaidCanvasCtx.globalAlpha=b}}else this.toolTip.mouseMoveHandler(a,d)};A.prototype._zoomPanToSelectedRegion=function(a,d,b,c,f){a=this.validateRegion(a,d,b,c,f);d=a.axesWithValidRange;b=a.axesRanges;if(a.isValid)for(c=0;c<d.length;c++)f=b[c],d[c].setViewPortRange(f.val1,f.val2);return a.isValid};A.prototype.validateRegion=function(a,d,b,c,
f){f=f||!1;for(var g=0<=this.zoomType.indexOf("x"),h=0<=this.zoomType.indexOf("y"),l=!1,k=[],n=[],m=[],p=0;p<this.axisX.length;p++)this.axisX[p]&&g&&n.push(this.axisX[p]);for(p=0;p<this.axisX2.length;p++)this.axisX2[p]&&g&&n.push(this.axisX2[p]);for(p=0;p<this.axisY.length;p++)this.axisY[p]&&h&&n.push(this.axisY[p]);for(p=0;p<this.axisY2.length;p++)this.axisY2[p]&&h&&n.push(this.axisY2[p]);for(g=0;g<n.length;g++){var h=n[g],p=h.convertPixelToValue({x:a,y:d}),e=h.convertPixelToValue({x:b,y:c});if(p>
e)var q=e,e=p,p=q;if(isFinite(h.dataInfo.minDiff))if(!(h.logarithmic&&e/p<Math.pow(h.dataInfo.minDiff,3)||!h.logarithmic&&Math.abs(e-p)<3*Math.abs(h.dataInfo.minDiff)||p<h.minimum||e>h.maximum))k.push(h),m.push({val1:p,val2:e}),l=!0;else if(!f){l=!1;break}}return{isValid:l,axesWithValidRange:k,axesRanges:m}};A.prototype.preparePlotArea=function(){var a=this.plotArea;!u&&(0<a.x1||0<a.y1)&&a.ctx.translate(a.x1,a.y1);if((this.axisX[0]||this.axisX2[0])&&(this.axisY[0]||this.axisY2[0])){var d=this.axisX[0]?
this.axisX[0].lineCoordinates:this.axisX2[0].lineCoordinates;if(this.axisY&&0<this.axisY.length&&this.axisY[0]){var b=this.axisY[0];a.x1=d.x1<d.x2?d.x1:b.lineCoordinates.x1;a.y1=d.y1<b.lineCoordinates.y1?d.y1:b.lineCoordinates.y1;a.x2=d.x2>b.lineCoordinates.x2?d.x2:b.lineCoordinates.x2;a.y2=d.y2>d.y1?d.y2:b.lineCoordinates.y2;a.width=a.x2-a.x1;a.height=a.y2-a.y1}this.axisY2&&0<this.axisY2.length&&this.axisY2[0]&&(b=this.axisY2[0],a.x1=d.x1<d.x2?d.x1:b.lineCoordinates.x1,a.y1=d.y1<b.lineCoordinates.y1?
d.y1:b.lineCoordinates.y1,a.x2=d.x2>b.lineCoordinates.x2?d.x2:b.lineCoordinates.x2,a.y2=d.y2>d.y1?d.y2:b.lineCoordinates.y2,a.width=a.x2-a.x1,a.height=a.y2-a.y1)}else d=this.layoutManager.getFreeSpace(),a.x1=d.x1,a.x2=d.x2,a.y1=d.y1,a.y2=d.y2,a.width=d.width,a.height=d.height;u||(a.canvas.width=a.width,a.canvas.height=a.height,a.canvas.style.left=a.x1+"px",a.canvas.style.top=a.y1+"px",(0<a.x1||0<a.y1)&&a.ctx.translate(-a.x1,-a.y1));a.layoutManager=new ja(a.x1,a.y1,a.x2,a.y2,2)};A.prototype.renderIndexLabels=
function(a){var d=a||this.plotArea.ctx,b=this.plotArea,c=0,f=0,g=0,h=0,l=c=h=f=g=0,k=0;for(a=0;a<this._indexLabels.length;a++){var n=this._indexLabels[a],m=n.chartType.toLowerCase(),p,e,l=L("indexLabelFontColor",n.dataPoint,n.dataSeries),k=L("indexLabelFontSize",n.dataPoint,n.dataSeries);p=L("indexLabelFontFamily",n.dataPoint,n.dataSeries);e=L("indexLabelFontStyle",n.dataPoint,n.dataSeries);var h=L("indexLabelFontWeight",n.dataPoint,n.dataSeries),q=L("indexLabelBackgroundColor",n.dataPoint,n.dataSeries),
f=L("indexLabelMaxWidth",n.dataPoint,n.dataSeries),g=L("indexLabelWrap",n.dataPoint,n.dataSeries),r=L("indexLabelLineDashType",n.dataPoint,n.dataSeries),s=L("indexLabelLineColor",n.dataPoint,n.dataSeries),v=x(n.dataPoint.indexLabelLineThickness)?x(n.dataSeries.options.indexLabelLineThickness)?0:n.dataSeries.options.indexLabelLineThickness:n.dataPoint.indexLabelLineThickness,c=0<v?Math.min(10,("normal"===this.plotInfo.axisPlacement?this.plotArea.height:this.plotArea.width)<<0):0,w={percent:null,total:null},
y=null;if(0<=n.dataSeries.type.indexOf("stacked")||"pie"===n.dataSeries.type||"doughnut"===n.dataSeries.type)w=this.getPercentAndTotal(n.dataSeries,n.dataPoint);if(n.dataSeries.indexLabelFormatter||n.dataPoint.indexLabelFormatter)y={chart:this,dataSeries:n.dataSeries,dataPoint:n.dataPoint,index:n.indexKeyword,total:w.total,percent:w.percent};var t=n.dataPoint.indexLabelFormatter?n.dataPoint.indexLabelFormatter(y):n.dataPoint.indexLabel?this.replaceKeywordsWithValue(n.dataPoint.indexLabel,n.dataPoint,
n.dataSeries,null,n.indexKeyword):n.dataSeries.indexLabelFormatter?n.dataSeries.indexLabelFormatter(y):n.dataSeries.indexLabel?this.replaceKeywordsWithValue(n.dataSeries.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):null;if(null!==t&&""!==t){var w=L("indexLabelPlacement",n.dataPoint,n.dataSeries),y=L("indexLabelOrientation",n.dataPoint,n.dataSeries),D=n.direction,Z=n.dataSeries.axisX,aa=n.dataSeries.axisY,z=!1,q=new W(d,{x:0,y:0,maxWidth:f?f:0.5*this.width,maxHeight:g?5*k:1.5*k,angle:"horizontal"===
y?0:-90,text:t,padding:0,backgroundColor:q,horizontalAlign:"left",fontSize:k,fontFamily:p,fontWeight:h,fontColor:l,fontStyle:e,textBaseline:"top"});q.measureText();n.dataSeries.indexLabelMaxWidth=q.maxWidth;if(0<=m.indexOf("line")||0<=m.indexOf("area")||0<=m.indexOf("bubble")||0<=m.indexOf("scatter")){if(n.dataPoint.x<Z.viewportMinimum||n.dataPoint.x>Z.viewportMaximum||n.dataPoint.y<aa.viewportMinimum||n.dataPoint.y>aa.viewportMaximum)continue}else if(0<=m.indexOf("column")){if(n.dataPoint.x<Z.viewportMinimum||
n.dataPoint.x>Z.viewportMaximum||n.bounds.y1>b.y2||n.bounds.y2<b.y1)continue}else if(0<=m.indexOf("bar")){if(n.dataPoint.x<Z.viewportMinimum||n.dataPoint.x>Z.viewportMaximum||n.bounds.x1>b.x2||n.bounds.x2<b.x1)continue}else if(n.dataPoint.x<Z.viewportMinimum||n.dataPoint.x>Z.viewportMaximum)continue;f=h=2;"horizontal"===y?(l=q.width,k=q.height):(k=q.width,l=q.height);if("normal"===this.plotInfo.axisPlacement){if(0<=m.indexOf("line")||0<=m.indexOf("area"))w="auto",h=4;else if(0<=m.indexOf("stacked"))"auto"===
w&&(w="inside");else if("bubble"===m||"scatter"===m)w="inside";p=n.point.x-l/2;"inside"!==w?(f=b.y1,g=b.y2,0<D?(e=n.point.y-k-h-c,e<f&&(e="auto"===w?Math.max(n.point.y,f)+h+c:f+h+c,z=e+k>n.point.y)):(e=n.point.y+h+c,e>g-k-h-c&&(e="auto"===w?Math.min(n.point.y,g)-k-h-c:g-k-h-c,z=e<n.point.y))):(f=Math.max(n.bounds.y1,b.y1),g=Math.min(n.bounds.y2,b.y2),c=0<=m.indexOf("range")?0<D?Math.max(n.bounds.y1,b.y1)+k/2+h:Math.min(n.bounds.y2,b.y2)-k/2-h:(Math.max(n.bounds.y1,b.y1)+Math.min(n.bounds.y2,b.y2))/
2,0<D?(e=Math.max(n.point.y,c)-k/2,e<f&&("bubble"===m||"scatter"===m)&&(e=Math.max(n.point.y-k-h,b.y1+h))):(e=Math.min(n.point.y,c)-k/2,e>g-k-h&&("bubble"===m||"scatter"===m)&&(e=Math.min(n.point.y+h,b.y2-k-h))),e=Math.min(e,g-k))}else 0<=m.indexOf("line")||0<=m.indexOf("area")||0<=m.indexOf("scatter")?(w="auto",f=4):0<=m.indexOf("stacked")?"auto"===w&&(w="inside"):"bubble"===m&&(w="inside"),e=n.point.y-k/2,"inside"!==w?(h=b.x1,g=b.x2,0>D?(p=n.point.x-l-f-c,p<h&&(p="auto"===w?Math.max(n.point.x,h)+
f+c:h+f+c,z=p+l>n.point.x)):(p=n.point.x+f+c,p>g-l-f-c&&(p="auto"===w?Math.min(n.point.x,g)-l-f-c:g-l-f-c,z=p<n.point.x))):(h=Math.max(n.bounds.x1,b.x1),Math.min(n.bounds.x2,b.x2),c=0<=m.indexOf("range")?0>D?Math.max(n.bounds.x1,b.x1)+l/2+f:Math.min(n.bounds.x2,b.x2)-l/2-f:(Math.max(n.bounds.x1,b.x1)+Math.min(n.bounds.x2,b.x2))/2,p=0>D?Math.max(n.point.x,c)-l/2:Math.min(n.point.x,c)-l/2,p=Math.max(p,h));"vertical"===y&&(e+=k);q.x=p;q.y=e;q.render(!0);v&&("inside"!==w&&(0>m.indexOf("bar")&&n.point.x>
b.x1&&n.point.x<b.x2||!z)&&(0>m.indexOf("column")&&n.point.y>b.y1&&n.point.y<b.y2||!z))&&(d.lineWidth=v,d.strokeStyle=s?s:"gray",d.setLineDash&&d.setLineDash(I(r,v)),d.beginPath(),d.moveTo(n.point.x,n.point.y),0<=m.indexOf("bar")?d.lineTo(p+(0<n.direction?0:l),e+("horizontal"===y?k:-k)/2):0<=m.indexOf("column")?d.lineTo(p+l/2,e+((0<n.direction?k:-k)+("horizontal"===y?k:-k))/2):d.lineTo(p+l/2,e+((e<n.point.y?k:-k)+("horizontal"===y?k:-k))/2),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:F.fadeInAnimation,
easingFunction:F.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)n=this._indexLabels[a],q=L("indexLabelBackgroundColor",n.dataPoint,n.dataSeries),n.dataSeries.indexLabelBackgroundColor=x(q)?u?"transparent":null:q;return d};A.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;d.save();var c=this.plotArea;d.beginPath();d.rect(c.x1,c.y1,c.width,c.height);d.clip();
for(var c=[],f=null,g=0;g<a.dataSeriesIndexes.length;g++){var h=a.dataSeriesIndexes[g],l=this.data[h];d.lineWidth=l.lineThickness;var k=l.dataPoints,n="solid";if(d.setLineDash){var m=I(l.nullDataLineDashType,l.lineThickness),n=l.lineDashType,p=I(n,l.lineThickness);d.setLineDash(p)}var e=l.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:h};e=G(e);b.strokeStyle=e;b.lineWidth=0<l.lineThickness?Math.max(l.lineThickness,4):0;var e=l._colorSet,q=e=l.lineColor=l.options.lineColor?
l.options.lineColor:e[0];d.strokeStyle=e;var r=!0,s=0,v,w;d.beginPath();if(0<k.length){for(var y=!1,s=0;s<k.length;s++)if(v=k[s].x.getTime?k[s].x.getTime():k[s].x,!(v<a.axisX.dataInfo.viewPortMin||v>a.axisX.dataInfo.viewPortMax&&(!l.connectNullData||!y)))if("number"!==typeof k[s].y)0<s&&!(l.connectNullData||y||r)&&(d.stroke(),u&&b.stroke()),y=!0;else{v=a.axisX.convertValueToPixel(v);w=a.axisY.convertValueToPixel(k[s].y);var t=l.dataPointIds[s];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",
dataSeriesIndex:h,dataPointIndex:s,x1:v,y1:w};r||y?(!r&&l.connectNullData?(d.setLineDash&&(l.options.nullDataLineDashType||n===l.lineDashType&&l.lineDashType!==l.nullDataLineDashType)&&(d.stroke(),n=l.nullDataLineDashType,d.setLineDash(m)),d.lineTo(v,w),u&&b.lineTo(v,w)):(d.beginPath(),d.moveTo(v,w),u&&(b.beginPath(),b.moveTo(v,w))),y=r=!1):(d.lineTo(v,w),u&&b.lineTo(v,w),0==s%500&&(d.stroke(),d.beginPath(),d.moveTo(v,w),u&&(b.stroke(),b.beginPath(),b.moveTo(v,w))));s<k.length-1&&(q!==(k[s].lineColor||
e)||n!==(k[s].lineDashType||l.lineDashType))&&(d.stroke(),d.beginPath(),d.moveTo(v,w),q=k[s].lineColor||e,d.strokeStyle=q,d.setLineDash&&(k[s].lineDashType?(n=k[s].lineDashType,d.setLineDash(I(n,l.lineThickness))):(n=l.lineDashType,d.setLineDash(p))));if(0<k[s].markerSize||0<l.markerSize){var D=l.getMarkerProperties(s,v,w,d),f=D.color;c.push(D);t=G(t);u&&c.push({x:v,y:w,ctx:b,type:D.type,size:D.size,color:t,borderColor:t,borderThickness:D.borderThickness})}(k[s].indexLabel||l.indexLabel||k[s].indexLabelFormatter||
l.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:k[s],dataSeries:l,point:{x:v,y:w},direction:0>k[s].y===a.axisY.reversed?1:-1,color:e})}d.stroke();u&&b.stroke()}}O.drawMarkers(c);l.markerColor=f;d.restore();d.beginPath();u&&b.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:F.xClipAnimation,easingFunction:F.easing.linear,animationBase:0}}};A.prototype.renderStepLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var b=
this._eventManager.ghostCtx;d.save();var c=this.plotArea;d.beginPath();d.rect(c.x1,c.y1,c.width,c.height);d.clip();for(var c=[],f=null,g=0;g<a.dataSeriesIndexes.length;g++){var h=a.dataSeriesIndexes[g],l=this.data[h];d.lineWidth=l.lineThickness;var k=l.dataPoints,n="solid";if(d.setLineDash){var m=I(l.nullDataLineDashType,l.lineThickness),n=l.lineDashType,p=I(n,l.lineThickness);d.setLineDash(p)}var e=l.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:h};e=G(e);b.strokeStyle=
e;b.lineWidth=0<l.lineThickness?Math.max(l.lineThickness,4):0;var e=l._colorSet,q=e=l.lineColor=l.options.lineColor?l.options.lineColor:e[0];d.strokeStyle=e;var r=!0,s=0,v,w;d.beginPath();if(0<k.length){for(var y=!1,s=0;s<k.length;s++)if(v=k[s].getTime?k[s].x.getTime():k[s].x,!(v<a.axisX.dataInfo.viewPortMin||v>a.axisX.dataInfo.viewPortMax&&(!l.connectNullData||!y)))if("number"!==typeof k[s].y)0<s&&!(l.connectNullData||y||r)&&(d.stroke(),u&&b.stroke()),y=!0;else{var t=w;v=a.axisX.convertValueToPixel(v);
w=a.axisY.convertValueToPixel(k[s].y);var D=l.dataPointIds[s];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:s,x1:v,y1:w};r||y?(!r&&l.connectNullData?(d.setLineDash&&(l.options.nullDataLineDashType||n===l.lineDashType&&l.lineDashType!==l.nullDataLineDashType)&&(d.stroke(),n=l.nullDataLineDashType,d.setLineDash(m)),d.lineTo(v,t),d.lineTo(v,w),u&&(b.lineTo(v,t),b.lineTo(v,w))):(d.beginPath(),d.moveTo(v,w),u&&(b.beginPath(),b.moveTo(v,w))),y=r=!1):(d.lineTo(v,
t),u&&b.lineTo(v,t),d.lineTo(v,w),u&&b.lineTo(v,w),0==s%500&&(d.stroke(),d.beginPath(),d.moveTo(v,w),u&&(b.stroke(),b.beginPath(),b.moveTo(v,w))));s<k.length-1&&(q!==(k[s].lineColor||e)||n!==(k[s].lineDashType||l.lineDashType))&&(d.stroke(),d.beginPath(),d.moveTo(v,w),q=k[s].lineColor||e,d.strokeStyle=q,d.setLineDash&&(k[s].lineDashType?(n=k[s].lineDashType,d.setLineDash(I(n,l.lineThickness))):(n=l.lineDashType,d.setLineDash(p))));if(0<k[s].markerSize||0<l.markerSize)t=l.getMarkerProperties(s,v,w,
d),f=t.color,c.push(t),D=G(D),u&&c.push({x:v,y:w,ctx:b,type:t.type,size:t.size,color:D,borderColor:D,borderThickness:t.borderThickness});(k[s].indexLabel||l.indexLabel||k[s].indexLabelFormatter||l.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:k[s],dataSeries:l,point:{x:v,y:w},direction:0>k[s].y===a.axisY.reversed?1:-1,color:e})}d.stroke();u&&b.stroke()}}O.drawMarkers(c);l.markerColor=f;d.restore();d.beginPath();u&&b.beginPath();return{source:d,dest:this.plotArea.ctx,
animationCallback:F.xClipAnimation,easingFunction:F.easing.linear,animationBase:0}}};A.prototype.renderSpline=function(a){function d(a){a=ua(a,2);if(0<a.length){b.beginPath();u&&c.beginPath();b.moveTo(a[0].x,a[0].y);a[0].newStrokeStyle&&(b.strokeStyle=a[0].newStrokeStyle);a[0].newLineDashArray&&b.setLineDash(a[0].newLineDashArray);u&&c.moveTo(a[0].x,a[0].y);for(var d=0;d<a.length-3;d+=3)if(b.bezierCurveTo(a[d+1].x,a[d+1].y,a[d+2].x,a[d+2].y,a[d+3].x,a[d+3].y),u&&c.bezierCurveTo(a[d+1].x,a[d+1].y,
a[d+2].x,a[d+2].y,a[d+3].x,a[d+3].y),0<d&&0===d%3E3||a[d+3].newStrokeStyle||a[d+3].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(a[d+3].x,a[d+3].y),a[d+3].newStrokeStyle&&(b.strokeStyle=a[d+3].newStrokeStyle),a[d+3].newLineDashArray&&b.setLineDash(a[d+3].newLineDashArray),u&&(c.stroke(),c.beginPath(),c.moveTo(a[d+3].x,a[d+3].y));b.stroke();u&&c.stroke()}}var b=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var c=this._eventManager.ghostCtx;b.save();var f=this.plotArea;
b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var f=[],g=null,h=0;h<a.dataSeriesIndexes.length;h++){var l=a.dataSeriesIndexes[h],k=this.data[l];b.lineWidth=k.lineThickness;var n=k.dataPoints,m="solid";if(b.setLineDash){var p=I(k.nullDataLineDashType,k.lineThickness),m=k.lineDashType,e=I(m,k.lineThickness);b.setLineDash(e)}var q=k.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:l};q=G(q);c.strokeStyle=q;c.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,
4):0;var q=k._colorSet,r=q=k.lineColor=k.options.lineColor?k.options.lineColor:q[0];b.strokeStyle=q;var s=0,v,w,y=[];b.beginPath();if(0<n.length)for(w=!1,s=0;s<n.length;s++)if(v=n[s].getTime?n[s].x.getTime():n[s].x,!(v<a.axisX.dataInfo.viewPortMin||v>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!w)))if("number"!==typeof n[s].y)0<s&&!w&&(k.connectNullData?b.setLineDash&&(0<y.length&&(k.options.nullDataLineDashType||!n[s-1].lineDashType))&&(y[y.length-1].newLineDashArray=p,m=k.nullDataLineDashType):
(d(y),y=[])),w=!0;else{v=a.axisX.convertValueToPixel(v);w=a.axisY.convertValueToPixel(n[s].y);var t=k.dataPointIds[s];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:l,dataPointIndex:s,x1:v,y1:w};y[y.length]={x:v,y:w};s<n.length-1&&(r!==(n[s].lineColor||q)||m!==(n[s].lineDashType||k.lineDashType))&&(r=n[s].lineColor||q,y[y.length-1].newStrokeStyle=r,b.setLineDash&&(n[s].lineDashType?(m=n[s].lineDashType,y[y.length-1].newLineDashArray=I(m,k.lineThickness)):(m=k.lineDashType,
y[y.length-1].newLineDashArray=e)));if(0<n[s].markerSize||0<k.markerSize){var D=k.getMarkerProperties(s,v,w,b),g=D.color;f.push(D);t=G(t);u&&f.push({x:v,y:w,ctx:c,type:D.type,size:D.size,color:t,borderColor:t,borderThickness:D.borderThickness})}(n[s].indexLabel||k.indexLabel||n[s].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[s],dataSeries:k,point:{x:v,y:w},direction:0>n[s].y===a.axisY.reversed?1:-1,color:q});w=!1}d(y)}O.drawMarkers(f);k.markerColor=
g;b.restore();b.beginPath();u&&c.beginPath();return{source:b,dest:this.plotArea.ctx,animationCallback:F.xClipAnimation,easingFunction:F.easing.linear,animationBase:0}}};var N=function(a,d,b,c,f,g,h,l,k,n,m,p,e){"undefined"===typeof e&&(e=1);h=h||0;l=l||"black";var q=15<c-d&&15<f-b?8:0.35*Math.min(c-d,f-b);a.beginPath();a.moveTo(d,b);a.save();a.fillStyle=g;a.globalAlpha=e;a.fillRect(d,b,c-d,f-b);a.globalAlpha=1;0<h&&(e=0===h%2?0:0.5,a.beginPath(),a.lineWidth=h,a.strokeStyle=l,a.moveTo(d,b),a.rect(d-
...
a.fillStyle=h,h.addColorStop(0,g),h.addColorStop(1,"rgba(255, 255, 255, 0.1)"),a.fillStyle=h,a.fill(),a.closePath(),a.restore())};A.prototype.renderColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var b=null,c=this.plotArea,f=0,g,h,l,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),f=this.dataPointMinWidth=this.dataPointMinWidth?this.dataPointMinWidth:this.dataPointWidth?this.dataPointWidth:1,n=this.dataPointMaxWidth=this.dataPointMaxWidth?
this.dataPointMaxWidth:this.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.width,0.9*(this.plotArea.width/a.plotType.totalDataSeries))<<0,m=a.axisX.dataInfo.minDiff;isFinite(m)||(m=0.3*Math.abs(a.axisX.range));m=this.dataPointWidth=this.dataPointWidth?this.dataPointWidth:0.9*(c.width*(a.axisX.logarithmic?Math.log(m)/Math.log(a.axisX.range):Math.abs(m)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>n&&(f=Math.min(this.dataPointWidth?this.dataPointWidth:Infinity,
n));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&n<f)&&(n=Math.max(this.dataPointWidth?this.dataPointWidth:-Infinity,f));m<f&&(m=f);m>n&&(m=n);d.save();u&&this._eventManager.ghostCtx.save();d.beginPath();d.rect(c.x1,c.y1,c.width,c.height);d.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(c.x1,c.y1,c.width,c.height),this._eventManager.ghostCtx.clip());for(c=0;c<a.dataSeriesIndexes.length;c++){var n=a.dataSeriesIndexes[c],p=this.data[n],e=p.dataPoints;if(0<e.length)for(var q=
5<m&&p.bevelEnabled?!0:!1,f=0;f<e.length;f++)if(e[f].getTime?l=e[f].x.getTime():l=e[f].x,!(l<a.axisX.dataInfo.viewPortMin||l>a.axisX.dataInfo.viewPortMax)&&"number"===typeof e[f].y){g=a.axisX.convertValueToPixel(l);h=a.axisY.convertValueToPixel(e[f].y);g=a.axisX.reversed?g+a.plotType.totalDataSeries*m/2-(a.previousDataSeriesCount+c)*m<<0:g-a.plotType.totalDataSeries*m/2+(a.previousDataSeriesCount+c)*m<<0;var r=a.axisX.reversed?g-m<<0:g+m<<0,s;0<=e[f].y?s=k:(s=h,h=k);h>s&&(b=h,h=s,s=b);b=e[f].color?
e[f].color:p._colorSet[f%p._colorSet.length];N(d,g,h,r,s,b,0,null,q&&0<=e[f].y,0>e[f].y&&q,!1,!1,p.fillOpacity);b=p.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:f,x1:g,y1:h,x2:r,y2:s};b=G(b);u&&N(this._eventManager.ghostCtx,g,h,r,s,b,0,null,!1,!1,!1,!1);(e[f].indexLabel||p.indexLabel||e[f].indexLabelFormatter||p.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:e[f],dataSeries:p,point:{x:g+(r-g)/2,y:0>e[f].y===
a.axisY.reversed?h:s},direction:0>e[f].y===a.axisY.reversed?1:-1,bounds:{x1:g,y1:Math.min(h,s),x2:r,y2:Math.max(h,s)},color:b})}}d.restore();u&&this._eventManager.ghostCtx.restore();a=Math.min(k,a.axisY.bounds.y2);return{source:d,dest:this.plotArea.ctx,animationCallback:F.yScaleAnimation,easingFunction:F.easing.easeOutQuart,animationBase:a}}};A.prototype.renderStackedColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var b=null,c=this.plotArea,f=[],
g=[],h=[],l=0,k,n=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),l=this.dataPointMinWidth?this.dataPointMinWidth:this.dataPointWidth?this.dataPointWidth:1,m=this.dataPointMaxWidth?this.dataPointMaxWidth:this.dataPointWidth?this.dataPointWidth:0.15*this.width<<0,p=a.axisX.dataInfo.minDiff;isFinite(p)||(p=0.3*Math.abs(a.axisX.range));p=this.dataPointWidth?this.dataPointWidth:0.9*(c.width*(a.axisX.logarithmic?Math.log(p)/Math.log(a.axisX.range):Math.abs(p)/Math.abs(a.axisX.range))/
a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&l>m&&(l=Math.min(this.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<l)&&(m=Math.max(this.dataPointWidth?this.dataPointWidth:-Infinity,l));p<l&&(p=l);p>m&&(p=m);d.save();u&&this._eventManager.ghostCtx.save();d.beginPath();d.rect(c.x1,c.y1,c.width,c.height);d.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(c.x1,c.y1,c.width,c.height),this._eventManager.ghostCtx.clip());
for(m=0;m<a.dataSeriesIndexes.length;m++){var e=a.dataSeriesIndexes[m],q=this.data[e],r=q.dataPoints;if(0<r.length){var s=5<p&&q.bevelEnabled?!0:!1;d.strokeStyle="#4572A7 ";for(l=0;l<r.length;l++)if(b=r[l].x.getTime?r[l].x.getTime():r[l].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[l].y){var c=a.axisX.convertValueToPixel(b),v=c-a.plotType.plotUnits.length*p/2+a.index*p<<0,w=v+p<<0,y;if(a.axisY.logarithmic)h[b]=r[l].y+(h[b]?h[b]:0),0<h[b]&&(k=a.axisY.convertValueToPixel(h[b]),
y=f[b]?f[b]:n,f[b]=k);else if(k=a.axisY.convertValueToPixel(r[l].y),0<=r[l].y){var t=f[b]?f[b]:0;k-=t;y=n-t;f[b]=t+(y-k)}else t=g[b]?g[b]:0,y=k+t,k=n+t,g[b]=t+(y-k);b=r[l].color?r[l].color:q._colorSet[l%q._colorSet.length];N(d,v,k,w,y,b,0,null,s&&0<=r[l].y,0>r[l].y&&s,!1,!1,q.fillOpacity);b=q.dataPointIds[l];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:e,dataPointIndex:l,x1:v,y1:k,x2:w,y2:y};b=G(b);u&&N(this._eventManager.ghostCtx,v,k,w,y,b,0,null,!1,!1,!1,!1);(r[l].indexLabel||
q.indexLabel||r[l].indexLabelFormatter||q.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:r[l],dataSeries:q,point:{x:c,y:0<=r[l].y?k:y},direction:0>r[l].y===a.axisY.reversed?1:-1,bounds:{x1:v,y1:Math.min(k,y),x2:w,y2:Math.max(k,y)},color:b})}}}d.restore();u&&this._eventManager.ghostCtx.restore();a=Math.min(n,a.axisY.bounds.y2);return{source:d,dest:this.plotArea.ctx,animationCallback:F.yScaleAnimation,easingFunction:F.easing.easeOutQuart,animationBase:a}}};A.prototype.renderStackedColumn100=
function(a){var d=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var b=null,c=this.plotArea,f=[],g=[],h=[],l=0,k,n=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),l=this.dataPointMinWidth?this.dataPointMinWidth:this.dataPointWidth?this.dataPointWidth:1,m=this.dataPointMaxWidth?this.dataPointMaxWidth:this.dataPointWidth?this.dataPointWidth:0.15*this.width<<0,p=a.axisX.dataInfo.minDiff;isFinite(p)||(p=0.3*Math.abs(a.axisX.range));p=this.dataPointWidth?
this.dataPointWidth:0.9*(c.width*(a.axisX.logarithmic?Math.log(p)/Math.log(a.axisX.range):Math.abs(p)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&l>m&&(l=Math.min(this.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<l)&&(m=Math.max(this.dataPointWidth?this.dataPointWidth:-Infinity,l));p<l&&(p=l);p>m&&(p=m);d.save();u&&this._eventManager.ghostCtx.save();d.beginPath();d.rect(c.x1,c.y1,c.width,c.height);d.clip();
u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(c.x1,c.y1,c.width,c.height),this._eventManager.ghostCtx.clip());for(m=0;m<a.dataSeriesIndexes.length;m++){var e=a.dataSeriesIndexes[m],q=this.data[e],r=q.dataPoints;if(0<r.length)for(var s=5<p&&q.bevelEnabled?!0:!1,l=0;l<r.length;l++)if(b=r[l].x.getTime?r[l].x.getTime():r[l].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[l].y){c=a.axisX.convertValueToPixel(b);k=0!==a.dataPointYSums[b]?
100*(r[l].y/a.dataPointYSums[b]):0;var v=c-a.plotType.plotUnits.length*p/2+a.index*p<<0,w=v+p<<0,y;if(a.axisY.logarithmic){h[b]=k+(h[b]?h[b]:0);if(0>=h[b])continue;k=a.axisY.convertValueToPixel(h[b]);y=f[b]?f[b]:n;f[b]=k}else if(k=a.axisY.convertValueToPixel(k),0<=r[l].y){var t=f[b]?f[b]:0;k-=t;y=n-t;f[b]=t+(y-k)}else t=g[b]?g[b]:0,y=k+t,k=n+t,g[b]=t+(y-k);b=r[l].color?r[l].color:q._colorSet[l%q._colorSet.length];N(d,v,k,w,y,b,0,null,s&&0<=r[l].y,0>r[l].y&&s,!1,!1,q.fillOpacity);b=q.dataPointIds[l];
this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:e,dataPointIndex:l,x1:v,y1:k,x2:w,y2:y};b=G(b);u&&N(this._eventManager.ghostCtx,v,k,w,y,b,0,null,!1,!1,!1,!1);(r[l].indexLabel||q.indexLabel||r[l].indexLabelFormatter||q.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn100",dataPoint:r[l],dataSeries:q,point:{x:c,y:0<=r[l].y?k:y},direction:0>r[l].y===a.axisY.reversed?1:-1,bounds:{x1:v,y1:Math.min(k,y),x2:w,y2:Math.max(k,y)},color:b})}}d.restore();u&&this._eventManager.ghostCtx.restore();
a=Math.min(n,a.axisY.bounds.y2);return{source:d,dest:this.plotArea.ctx,animationCallback:F.yScaleAnimation,easingFunction:F.easing.easeOutQuart,animationBase:a}}};A.prototype.renderBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var b=null,c=this.plotArea,f=0,g,h,l,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),f=this.dataPointMinWidth?this.dataPointMinWidth:this.dataPointWidth?this.dataPointWidth:1,n=this.dataPointMaxWidth?
this.dataPointMaxWidth:this.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.height,0.9*(this.plotArea.height/a.plotType.totalDataSeries))<<0,m=a.axisX.dataInfo.minDiff;isFinite(m)||(m=0.3*Math.abs(a.axisX.range));m=this.dataPointWidth?this.dataPointWidth:0.9*(c.height*(a.axisX.logarithmic?Math.log(m)/Math.log(a.axisX.range):Math.abs(m)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>n&&(f=Math.min(this.dataPointWidth?this.dataPointWidth:Infinity,n));!this.dataPointMaxWidth&&
(this.dataPointMinWidth&&n<f)&&(n=Math.max(this.dataPointWidth?this.dataPointWidth:-Infinity,f));m<f&&(m=f);m>n&&(m=n);d.save();u&&this._eventManager.ghostCtx.save();d.beginPath();d.rect(c.x1,c.y1,c.width,c.height);d.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(c.x1,c.y1,c.width,c.height),this._eventManager.ghostCtx.clip());for(c=0;c<a.dataSeriesIndexes.length;c++){var n=a.dataSeriesIndexes[c],p=this.data[n],e=p.dataPoints;if(0<e.length){var q=5<m&&p.bevelEnabled?
!0:!1;d.strokeStyle="#4572A7 ";for(f=0;f<e.length;f++)if(e[f].getTime?l=e[f].x.getTime():l=e[f].x,!(l<a.axisX.dataInfo.viewPortMin||l>a.axisX.dataInfo.viewPortMax)&&"number"===typeof e[f].y){h=a.axisX.convertValueToPixel(l);g=a.axisY.convertValueToPixel(e[f].y);h=a.axisX.reversed?h+a.plotType.totalDataSeries*m/2-(a.previousDataSeriesCount+c)*m<<0:h-a.plotType.totalDataSeries*m/2+(a.previousDataSeriesCount+c)*m<<0;var r=a.axisX.reversed?h-m<<0:h+m<<0,s;0<=e[f].y?s=k:(s=g,g=k);b=e[f].color?e[f].color:
p._colorSet[f%p._colorSet.length];N(d,s,h,g,r,b,0,null,q,!1,!1,!1,p.fillOpacity);b=p.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:f,x1:s,y1:h,x2:g,y2:r};b=G(b);u&&N(this._eventManager.ghostCtx,s,h,g,r,b,0,null,!1,!1,!1,!1);(e[f].indexLabel||p.indexLabel||e[f].indexLabelFormatter||p.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",dataPoint:e[f],dataSeries:p,point:{x:0<=e[f].y?g:s,y:h+(r-h)/2},direction:0>e[f].y===a.axisY.reversed?
1:-1,bounds:{x1:Math.min(s,g),y1:h,x2:Math.max(s,g),y2:r},color:b})}}}d.restore();u&&this._eventManager.ghostCtx.restore();a=Math.max(k,a.axisX.bounds.x2);return{source:d,dest:this.plotArea.ctx,animationCallback:F.xScaleAnimation,easingFunction:F.easing.easeOutQuart,animationBase:a}}};A.prototype.renderStackedBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var b=null,c=this.plotArea,f=[],g=[],h=[],l=0,k,n=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),l=this.dataPointMinWidth?this.dataPointMinWidth:this.dataPointWidth?this.dataPointWidth:1,m=this.dataPointMaxWidth?this.dataPointMaxWidth:this.dataPointWidth?this.dataPointWidth:0.15*this.height<<0,p=a.axisX.dataInfo.minDiff;isFinite(p)||(p=0.3*Math.abs(a.axisX.range));p=this.dataPointWidth?this.dataPointWidth:0.9*(c.height*(a.axisX.logarithmic?Math.log(p)/Math.log(a.axisX.range):Math.abs(p)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&
...
a.dataSeriesIndexes[m],q=this.data[e],r=q.dataPoints;if(0<r.length){var s=5<p&&q.bevelEnabled?!0:!1;d.strokeStyle="#4572A7 ";for(l=0;l<r.length;l++)if(b=r[l].x.getTime?r[l].x.getTime():r[l].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[l].y){var c=a.axisX.convertValueToPixel(b),v=c-a.plotType.plotUnits.length*p/2+a.index*p<<0,w=v+p<<0,y;if(a.axisY.logarithmic)h[b]=r[l].y+(h[b]?h[b]:0),0<h[b]&&(y=f[b]?f[b]:n,f[b]=k=a.axisY.convertValueToPixel(h[b]));else if(k=
a.axisY.convertValueToPixel(r[l].y),0<=r[l].y){var t=f[b]?f[b]:0;y=n+t;k+=t;f[b]=t+(k-y)}else t=g[b]?g[b]:0,y=k-t,k=n-t,g[b]=t+(k-y);b=r[l].color?r[l].color:q._colorSet[l%q._colorSet.length];N(d,y,v,k,w,b,0,null,s,!1,!1,!1,q.fillOpacity);b=q.dataPointIds[l];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:e,dataPointIndex:l,x1:y,y1:v,x2:k,y2:w};b=G(b);u&&N(this._eventManager.ghostCtx,y,v,k,w,b,0,null,!1,!1,!1,!1);(r[l].indexLabel||q.indexLabel||r[l].indexLabelFormatter||
q.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:r[l],dataSeries:q,point:{x:0<=r[l].y?k:y,y:c},direction:0>r[l].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(y,k),y1:v,x2:Math.max(y,k),y2:w},color:b})}}}d.restore();u&&this._eventManager.ghostCtx.restore();a=Math.max(n,a.axisX.bounds.x2);return{source:d,dest:this.plotArea.ctx,animationCallback:F.xScaleAnimation,easingFunction:F.easing.easeOutQuart,animationBase:a}}};A.prototype.renderStackedBar100=function(a){var d=
a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var b=null,c=this.plotArea,f=[],g=[],h=[],l=0,k,n=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),l=this.dataPointMinWidth?this.dataPointMinWidth:this.dataPointWidth?this.dataPointWidth:1,m=this.dataPointMaxWidth?this.dataPointMaxWidth:this.dataPointWidth?this.dataPointWidth:0.15*this.height<<0,p=a.axisX.dataInfo.minDiff;isFinite(p)||(p=0.3*Math.abs(a.axisX.range));p=this.dataPointWidth?this.dataPointWidth:
0.9*(c.height*(a.axisX.logarithmic?Math.log(p)/Math.log(a.axisX.range):Math.abs(p)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&l>m&&(l=Math.min(this.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<l)&&(m=Math.max(this.dataPointWidth?this.dataPointWidth:-Infinity,l));p<l&&(p=l);p>m&&(p=m);d.save();u&&this._eventManager.ghostCtx.save();d.beginPath();d.rect(c.x1,c.y1,c.width,c.height);d.clip();u&&(this._eventManager.ghostCtx.beginPath(),
this._eventManager.ghostCtx.rect(c.x1,c.y1,c.width,c.height),this._eventManager.ghostCtx.clip());for(m=0;m<a.dataSeriesIndexes.length;m++){var e=a.dataSeriesIndexes[m],q=this.data[e],r=q.dataPoints;if(0<r.length){var s=5<p&&q.bevelEnabled?!0:!1;d.strokeStyle="#4572A7 ";for(l=0;l<r.length;l++)if(b=r[l].x.getTime?r[l].x.getTime():r[l].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[l].y){var c=a.axisX.convertValueToPixel(b),v;v=0!==a.dataPointYSums[b]?100*(r[l].y/
a.dataPointYSums[b]):0;var w=c-a.plotType.plotUnits.length*p/2+a.index*p<<0,y=w+p<<0;if(a.axisY.logarithmic){h[b]=v+(h[b]?h[b]:0);if(0>=h[b])continue;v=f[b]?f[b]:n;f[b]=k=a.axisY.convertValueToPixel(h[b])}else if(k=a.axisY.convertValueToPixel(v),0<=r[l].y){var t=f[b]?f[b]:0;v=n+t;k+=t;f[b]=t+(k-v)}else t=g[b]?g[b]:0,v=k-t,k=n-t,g[b]=t+(k-v);b=r[l].color?r[l].color:q._colorSet[l%q._colorSet.length];N(d,v,w,k,y,b,0,null,s,!1,!1,!1,q.fillOpacity);b=q.dataPointIds[l];this._eventManager.objectMap[b]={id:b,
objectType:"dataPoint",dataSeriesIndex:e,dataPointIndex:l,x1:v,y1:w,x2:k,y2:y};b=G(b);u&&N(this._eventManager.ghostCtx,v,w,k,y,b,0,null,!1,!1,!1,!1);(r[l].indexLabel||q.indexLabel||r[l].indexLabelFormatter||q.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:r[l],dataSeries:q,point:{x:0<=r[l].y?k:v,y:c},direction:0>r[l].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(v,k),y1:w,x2:Math.max(v,k),y2:y},color:b})}}}d.restore();u&&this._eventManager.ghostCtx.restore();a=Math.max(n,
a.axisX.bounds.x2);return{source:d,dest:this.plotArea.ctx,animationCallback:F.xScaleAnimation,easingFunction:F.easing.easeOutQuart,animationBase:a}}};A.prototype.renderArea=function(a){function d(){t&&(0<m.lineThickness&&b.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?y=w:0>a.axisY.viewportMaximum?y=g.y1:0<a.axisY.viewportMinimum&&(y=f.y2),b.lineTo(r,y),b.lineTo(t.x,y),b.closePath(),b.globalAlpha=m.fillOpacity,b.fill(),b.globalAlpha=1,u&&(c.lineTo(r,y),c.lineTo(t.x,
y),c.closePath(),c.fill()),b.beginPath(),b.moveTo(r,s),c.beginPath(),c.moveTo(r,s),t={x:r,y:s})}var b=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var c=this._eventManager.ghostCtx,f=a.axisX.lineCoordinates,g=a.axisY.lineCoordinates,h=[],l=null,k=this.plotArea;b.save();u&&c.save();b.beginPath();b.rect(k.x1,k.y1,k.width,k.height);b.clip();u&&(c.beginPath(),c.rect(k.x1,k.y1,k.width,k.height),c.clip());for(k=0;k<a.dataSeriesIndexes.length;k++){var n=a.dataSeriesIndexes[k],
m=this.data[n],p=m.dataPoints,h=m.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:n};h=G(h);c.fillStyle=h;var h=[],e=!0,q=0,r,s,v,w=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),y,t=null;if(0<p.length){var D=m._colorSet[q%m._colorSet.length],x=m.lineColor=m.options.lineColor||D,aa=x;b.fillStyle=D;b.strokeStyle=x;b.lineWidth=m.lineThickness;var z="solid";if(b.setLineDash){var A=I(m.nullDataLineDashType,m.lineThickness),z=m.lineDashType,R=I(z,
m.lineThickness);b.setLineDash(R)}for(var J=!0;q<p.length;q++)if(v=p[q].x.getTime?p[q].x.getTime():p[q].x,!(v<a.axisX.dataInfo.viewPortMin||v>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!J)))if("number"!==typeof p[q].y)m.connectNullData||(J||e)||d(),J=!0;else{r=a.axisX.convertValueToPixel(v);s=a.axisY.convertValueToPixel(p[q].y);e||J?(!e&&m.connectNullData?(b.setLineDash&&(m.options.nullDataLineDashType||z===m.lineDashType&&m.lineDashType!==m.nullDataLineDashType)&&(b.stroke(),z=m.nullDataLineDashType,
b.setLineDash(A)),b.lineTo(r,s),u&&c.lineTo(r,s)):(b.beginPath(),b.moveTo(r,s),u&&(c.beginPath(),c.moveTo(r,s)),t={x:r,y:s}),J=e=!1):(b.lineTo(r,s),u&&c.lineTo(r,s),0==q%250&&d());q<p.length-1&&(aa!==(p[q].lineColor||x)||z!==(p[q].lineDashType||m.lineDashType))&&(d(),aa=p[q].lineColor||x,b.strokeStyle=aa,b.setLineDash&&(p[q].lineDashType?(z=p[q].lineDashType,b.setLineDash(I(z,m.lineThickness))):(z=m.lineDashType,b.setLineDash(R))));var H=m.dataPointIds[q];this._eventManager.objectMap[H]={id:H,objectType:"dataPoint",
dataSeriesIndex:n,dataPointIndex:q,x1:r,y1:s};0!==p[q].markerSize&&(0<p[q].markerSize||0<m.markerSize)&&(v=m.getMarkerProperties(q,r,s,b),l=v.color,h.push(v),H=G(H),u&&h.push({x:r,y:s,ctx:c,type:v.type,size:v.size,color:H,borderColor:H,borderThickness:v.borderThickness}));(p[q].indexLabel||m.indexLabel||p[q].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:p[q],dataSeries:m,point:{x:r,y:s},direction:0>p[q].y===a.axisY.reversed?1:-1,color:D})}d();O.drawMarkers(h);
m.markerColor=l}}b.restore();u&&this._eventManager.ghostCtx.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:F.xClipAnimation,easingFunction:F.easing.linear,animationBase:0}}};A.prototype.renderSplineArea=function(a){function d(){var d=ua(y,2);if(0<d.length){if(0<m.lineThickness){b.beginPath();b.moveTo(d[0].x,d[0].y);d[0].newStrokeStyle&&(b.strokeStyle=d[0].newStrokeStyle);d[0].newLineDashArray&&b.setLineDash(d[0].newLineDashArray);for(var e=0;e<d.length-3;e+=3)if(b.bezierCurveTo(d[e+
1].x,d[e+1].y,d[e+2].x,d[e+2].y,d[e+3].x,d[e+3].y),u&&c.bezierCurveTo(d[e+1].x,d[e+1].y,d[e+2].x,d[e+2].y,d[e+3].x,d[e+3].y),d[e+3].newStrokeStyle||d[e+3].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[e+3].x,d[e+3].y),d[e+3].newStrokeStyle&&(b.strokeStyle=d[e+3].newStrokeStyle),d[e+3].newLineDashArray&&b.setLineDash(d[e+3].newLineDashArray);b.stroke()}b.beginPath();b.moveTo(d[0].x,d[0].y);u&&(c.beginPath(),c.moveTo(d[0].x,d[0].y));for(e=0;e<d.length-3;e+=3)b.bezierCurveTo(d[e+1].x,d[e+1].y,
d[e+2].x,d[e+2].y,d[e+3].x,d[e+3].y),u&&c.bezierCurveTo(d[e+1].x,d[e+1].y,d[e+2].x,d[e+2].y,d[e+3].x,d[e+3].y);a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?v=s:0>a.axisY.viewportMaximum?v=g.y1:0<a.axisY.viewportMinimum&&(v=f.y2);w={x:d[0].x,y:d[0].y};b.lineTo(d[d.length-1].x,v);b.lineTo(w.x,v);b.closePath();b.globalAlpha=m.fillOpacity;b.fill();b.globalAlpha=1;u&&(c.lineTo(d[d.length-1].x,v),c.lineTo(w.x,v),c.closePath(),c.fill())}}var b=a.targetCanvasCtx||this.plotArea.ctx;
if(!(0>=a.dataSeriesIndexes.length)){var c=this._eventManager.ghostCtx,f=a.axisX.lineCoordinates,g=a.axisY.lineCoordinates,h=[],l=null,k=this.plotArea;b.save();u&&c.save();b.beginPath();b.rect(k.x1,k.y1,k.width,k.height);b.clip();u&&(c.beginPath(),c.rect(k.x1,k.y1,k.width,k.height),c.clip());for(k=0;k<a.dataSeriesIndexes.length;k++){var n=a.dataSeriesIndexes[k],m=this.data[n],p=m.dataPoints,h=m.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:n};h=G(h);c.fillStyle=h;var h=
[],e=0,q,r,s=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),v,w=null,y=[];if(0<p.length){var t=m._colorSet[e%m._colorSet.length],D=m.lineColor=m.options.lineColor||t,x=D;b.fillStyle=t;b.strokeStyle=D;b.lineWidth=m.lineThickness;var z="solid";if(b.setLineDash){var A=I(m.nullDataLineDashType,m.lineThickness),z=m.lineDashType,B=I(z,m.lineThickness);b.setLineDash(B)}for(r=!1;e<p.length;e++)if(q=p[e].x.getTime?p[e].x.getTime():p[e].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&
(!m.connectNullData||!r)))if("number"!==typeof p[e].y)0<e&&!r&&(m.connectNullData?b.setLineDash&&(0<y.length&&(m.options.nullDataLineDashType||!p[e-1].lineDashType))&&(y[y.length-1].newLineDashArray=A,z=m.nullDataLineDashType):(d(),y=[])),r=!0;else{q=a.axisX.convertValueToPixel(q);r=a.axisY.convertValueToPixel(p[e].y);var R=m.dataPointIds[e];this._eventManager.objectMap[R]={id:R,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:e,x1:q,y1:r};y[y.length]={x:q,y:r};e<p.length-1&&(x!==(p[e].lineColor||
D)||z!==(p[e].lineDashType||m.lineDashType))&&(x=p[e].lineColor||D,y[y.length-1].newStrokeStyle=x,b.setLineDash&&(p[e].lineDashType?(z=p[e].lineDashType,y[y.length-1].newLineDashArray=I(z,m.lineThickness)):(z=m.lineDashType,y[y.length-1].newLineDashArray=B)));if(0!==p[e].markerSize&&(0<p[e].markerSize||0<m.markerSize)){var J=m.getMarkerProperties(e,q,r,b),l=J.color;h.push(J);R=G(R);u&&h.push({x:q,y:r,ctx:c,type:J.type,size:J.size,color:R,borderColor:R,borderThickness:J.borderThickness})}(p[e].indexLabel||
m.indexLabel||p[e].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[e],dataSeries:m,point:{x:q,y:r},direction:0>p[e].y===a.axisY.reversed?1:-1,color:t});r=!1}d();O.drawMarkers(h);m.markerColor=l}}b.restore();u&&this._eventManager.ghostCtx.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:F.xClipAnimation,easingFunction:F.easing.linear,animationBase:0}}};A.prototype.renderStepArea=function(a){function d(){t&&(0<m.lineThickness&&
...
y,t=null,D=!1;if(0<p.length){var x=m._colorSet[q%m._colorSet.length],z=m.lineColor=m.options.lineColor||x,A=z;b.fillStyle=x;b.strokeStyle=z;b.lineWidth=m.lineThickness;var B="solid";if(b.setLineDash){var R=I(m.nullDataLineDashType,m.lineThickness),B=m.lineDashType,J=I(B,m.lineThickness);b.setLineDash(J)}for(;q<p.length;q++)if(v=p[q].x.getTime?p[q].x.getTime():p[q].x,!(v<a.axisX.dataInfo.viewPortMin||v>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!D))){var H=s;"number"!==typeof p[q].y?(m.connectNullData||
(D||e)||d(),D=!0):(r=a.axisX.convertValueToPixel(v),s=a.axisY.convertValueToPixel(p[q].y),e||D?(!e&&m.connectNullData?(b.setLineDash&&(m.options.nullDataLineDashType||B===m.lineDashType&&m.lineDashType!==m.nullDataLineDashType)&&(b.stroke(),B=m.nullDataLineDashType,b.setLineDash(R)),b.lineTo(r,H),b.lineTo(r,s),u&&(c.lineTo(r,H),c.lineTo(r,s))):(b.beginPath(),b.moveTo(r,s),u&&(c.beginPath(),c.moveTo(r,s)),t={x:r,y:s}),D=e=!1):(b.lineTo(r,H),u&&c.lineTo(r,H),b.lineTo(r,s),u&&c.lineTo(r,s),0==q%250&&
d()),q<p.length-1&&(A!==(p[q].lineColor||z)||B!==(p[q].lineDashType||m.lineDashType))&&(d(),A=p[q].lineColor||z,b.strokeStyle=A,b.setLineDash&&(p[q].lineDashType?(B=p[q].lineDashType,b.setLineDash(I(B,m.lineThickness))):(B=m.lineDashType,b.setLineDash(J)))),H=m.dataPointIds[q],this._eventManager.objectMap[H]={id:H,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:q,x1:r,y1:s},0!==p[q].markerSize&&(0<p[q].markerSize||0<m.markerSize)&&(v=m.getMarkerProperties(q,r,s,b),l=v.color,h.push(v),H=G(H),
u&&h.push({x:r,y:s,ctx:c,type:v.type,size:v.size,color:H,borderColor:H,borderThickness:v.borderThickness})),(p[q].indexLabel||m.indexLabel||p[q].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:p[q],dataSeries:m,point:{x:r,y:s},direction:0>p[q].y===a.axisY.reversed?1:-1,color:x}))}d();O.drawMarkers(h);m.markerColor=l}}b.restore();u&&this._eventManager.ghostCtx.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:F.xClipAnimation,easingFunction:F.easing.linear,
animationBase:0}}};A.prototype.renderStackedArea=function(a){function d(){if(!(1>k.length)){for(0<t.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);u&&v.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=t.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();u&&(v.closePath(),v.fill(),v.beginPath());k=[]}}var b=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var c=null,f=[],g=null,h=this.plotArea,l=[],k=[],n=[],m=[],p=0,e,q,r,s=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),v=this._eventManager.ghostCtx;u&&v.beginPath();b.save();u&&v.save();b.beginPath();b.rect(h.x1,h.y1,h.width,h.height);b.clip();u&&(v.beginPath(),v.rect(h.x1,h.y1,h.width,h.height),v.clip());for(var w=[],h=0;h<a.dataSeriesIndexes.length;h++){var y=a.dataSeriesIndexes[h],t=this.data[y],D=t.dataPoints;t.dataPointIndexes=[];for(p=0;p<D.length;p++)y=D[p].x.getTime?D[p].x.getTime():D[p].x,t.dataPointIndexes[y]=p,w[y]||(n.push(y),w[y]=!0);n.sort(ya)}for(h=0;h<a.dataSeriesIndexes.length;h++){y=
a.dataSeriesIndexes[h];t=this.data[y];D=t.dataPoints;w=!0;k=[];p=t.id;this._eventManager.objectMap[p]={objectType:"dataSeries",dataSeriesIndex:y};p=G(p);v.fillStyle=p;if(0<n.length){var c=t._colorSet[0],x=t.lineColor=t.options.lineColor||c,z=x;b.fillStyle=c;b.strokeStyle=x;b.lineWidth=t.lineThickness;var A="solid";if(b.setLineDash){var B=I(t.nullDataLineDashType,t.lineThickness),A=t.lineDashType,R=I(A,t.lineThickness);b.setLineDash(R)}for(var J=!0,p=0;p<n.length;p++){r=n[p];var H=null,H=0<=t.dataPointIndexes[r]?
D[t.dataPointIndexes[r]]:{x:r,y:null};if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax&&(!t.connectNullData||!J)))if("number"!==typeof H.y)t.connectNullData||(J||w)||d(),J=!0;else{e=a.axisX.convertValueToPixel(r);var ea=l[r]?l[r]:0;if(a.axisY.logarithmic){m[r]=H.y+(m[r]?m[r]:0);if(0>=m[r])continue;q=a.axisY.convertValueToPixel(m[r])}else q=a.axisY.convertValueToPixel(H.y),q-=ea;k.push({x:e,y:s-ea});l[r]=s-q;w||J?(!w&&t.connectNullData?(b.setLineDash&&(t.options.nullDataLineDashType||
A===t.lineDashType&&t.lineDashType!==t.nullDataLineDashType)&&(b.stroke(),A=t.nullDataLineDashType,b.setLineDash(B)),b.lineTo(e,q),u&&v.lineTo(e,q)):(b.beginPath(),b.moveTo(e,q),u&&(v.beginPath(),v.moveTo(e,q))),J=w=!1):(b.lineTo(e,q),u&&v.lineTo(e,q),0==p%250&&(d(),b.moveTo(e,q),u&&v.moveTo(e,q),k.push({x:e,y:s-ea})));p<D.length-1&&(z!==(D[p].lineColor||x)||A!==(D[p].lineDashType||t.lineDashType))&&(d(),b.beginPath(),b.moveTo(e,q),k.push({x:e,y:s-ea}),z=D[p].lineColor||x,b.strokeStyle=z,b.setLineDash&&
...
size:r.size,color:markerColor,borderColor:markerColor,borderThickness:r.borderThickness}));(H.indexLabel||t.indexLabel||H.indexLabelFormatter||t.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:H,dataSeries:t,point:{x:e,y:q},direction:0>D[p].y===a.axisY.reversed?1:-1,color:c})}}d();b.moveTo(e,q);u&&v.moveTo(e,q)}delete t.dataPointIndexes;t.markerColor=g}O.drawMarkers(f);b.restore();u&&v.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:F.xClipAnimation,
easingFunction:F.easing.linear,animationBase:0}}};A.prototype.renderStackedArea100=function(a){function d(){for(0<t.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);u&&v.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=t.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();u&&(v.closePath(),v.fill(),v.beginPath());k=[]}var b=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var c=null,f=this.plotArea,g=[],h=null,l=[],k=[],n=[],m=[],p=0,e,q,r,s=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),v=this._eventManager.ghostCtx;b.save();u&&v.save();b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();u&&(v.beginPath(),v.rect(f.x1,f.y1,f.width,f.height),v.clip());for(var w=[],f=0;f<a.dataSeriesIndexes.length;f++){var y=a.dataSeriesIndexes[f],t=this.data[y],x=t.dataPoints;t.dataPointIndexes=[];for(p=0;p<x.length;p++)y=x[p].x.getTime?x[p].x.getTime():x[p].x,t.dataPointIndexes[y]=p,w[y]||(n.push(y),w[y]=!0);n.sort(ya)}for(f=0;f<a.dataSeriesIndexes.length;f++){y=a.dataSeriesIndexes[f];
t=this.data[y];x=t.dataPoints;w=!0;c=t.id;this._eventManager.objectMap[c]={objectType:"dataSeries",dataSeriesIndex:y};c=G(c);v.fillStyle=c;k=[];if(0<n.length){var c=t._colorSet[p%t._colorSet.length],z=t.lineColor=t.options.lineColor||c,A=z;b.fillStyle=c;b.strokeStyle=z;b.lineWidth=t.lineThickness;var B="solid";if(b.setLineDash){var E=I(t.nullDataLineDashType,t.lineThickness),B=t.lineDashType,R=I(B,t.lineThickness);b.setLineDash(R)}for(var J=!0,p=0;p<n.length;p++){r=n[p];var H=null,H=0<=t.dataPointIndexes[r]?
x[t.dataPointIndexes[r]]:{x:r,y:null};if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax&&(!t.connectNullData||!J)))if("number"!==typeof H.y)t.connectNullData||(J||w)||d(),J=!0;else{var ea;ea=0!==a.dataPointYSums[r]?100*(H.y/a.dataPointYSums[r]):0;e=a.axisX.convertValueToPixel(r);var fa=l[r]?l[r]:0;if(a.axisY.logarithmic){m[r]=ea+(m[r]?m[r]:0);if(0>=m[r])continue;q=a.axisY.convertValueToPixel(m[r])}else q=a.axisY.convertValueToPixel(ea),q-=fa;k.push({x:e,y:s-fa});l[r]=s-q;w||J?(!w&&
t.connectNullData?(b.setLineDash&&(t.options.nullDataLineDashType||B===t.lineDashType&&t.lineDashType!==t.nullDataLineDashType)&&(b.stroke(),B=t.nullDataLineDashType,b.setLineDash(E)),b.lineTo(e,q),u&&v.lineTo(e,q)):(b.beginPath(),b.moveTo(e,q),u&&(v.beginPath(),v.moveTo(e,q))),J=w=!1):(b.lineTo(e,q),u&&v.lineTo(e,q),0==p%250&&(d(),b.moveTo(e,q),u&&v.moveTo(e,q),k.push({x:e,y:s-fa})));p<x.length-1&&(A!==(x[p].lineColor||z)||B!==(x[p].lineDashType||t.lineDashType))&&(d(),b.beginPath(),b.moveTo(e,q),
k.push({x:e,y:s-fa}),A=x[p].lineColor||z,b.strokeStyle=A,b.setLineDash&&(x[p].lineDashType?(B=x[p].lineDashType,b.setLineDash(I(B,t.lineThickness))):(B=t.lineDashType,b.setLineDash(R))));if(0<=t.dataPointIndexes[r]){var Fa=t.dataPointIds[t.dataPointIndexes[r]];this._eventManager.objectMap[Fa]={id:Fa,objectType:"dataPoint",dataSeriesIndex:y,dataPointIndex:t.dataPointIndexes[r],x1:e,y1:q}}0<=t.dataPointIndexes[r]&&0!==H.markerSize&&(0<H.markerSize||0<t.markerSize)&&(r=t.getMarkerProperties(p,e,q,b),
h=r.color,g.push(r),markerColor=G(Fa),u&&g.push({x:e,y:q,ctx:v,type:r.type,size:r.size,color:markerColor,borderColor:markerColor,borderThickness:r.borderThickness}));(H.indexLabel||t.indexLabel||H.indexLabelFormatter||t.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:H,dataSeries:t,point:{x:e,y:q},direction:0>x[p].y===a.axisY.reversed?1:-1,color:c})}}d();b.moveTo(e,q);u&&v.moveTo(e,q)}delete t.dataPointIndexes;t.markerColor=h}O.drawMarkers(g);b.restore();u&&v.restore();
...
for(var h=-Infinity,l=Infinity,k=0;k<a.dataSeriesIndexes.length;k++)for(var n=a.dataSeriesIndexes[k],m=this.data[n],p=m.dataPoints,e=0,c=0;c<p.length;c++)f=p[c].getTime?f=p[c].x.getTime():f=p[c].x,f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax||"undefined"===typeof p[c].z||(e=p[c].z,e>h&&(h=e),e<l&&(l=e));for(var q=25*Math.PI,b=Math.max(Math.pow(0.25*Math.min(b.height,b.width)/2,2)*Math.PI,q),k=0;k<a.dataSeriesIndexes.length;k++)if(n=a.dataSeriesIndexes[k],m=this.data[n],p=m.dataPoints,
0<p.length)for(d.strokeStyle="#4572A7 ",c=0;c<p.length;c++)if(f=p[c].getTime?f=p[c].x.getTime():f=p[c].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof p[c].y){f=a.axisX.convertValueToPixel(f);g=a.axisY.convertValueToPixel(p[c].y);var e=p[c].z,r=2*Math.max(Math.sqrt((h===l?b/2:q+(b-q)/(h-l)*(e-l))/Math.PI)<<0,1),e=m.getMarkerProperties(c,d);e.size=r;d.globalAlpha=m.fillOpacity;O.drawMarker(f,g,d,e.type,e.size,e.color,e.borderColor,e.borderThickness);d.globalAlpha=
1;var s=m.dataPointIds[c];this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:c,x1:f,y1:g,size:r};r=G(s);u&&O.drawMarker(f,g,this._eventManager.ghostCtx,e.type,e.size,r,r,e.borderThickness);(p[c].indexLabel||m.indexLabel||p[c].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"bubble",dataPoint:p[c],dataSeries:m,point:{x:f,y:g},direction:1,bounds:{x1:f-e.size/2,y1:g-e.size/2,x2:f+e.size/2,y2:g+e.size/2},color:null})}d.restore();
u&&this._eventManager.ghostCtx.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:F.fadeInAnimation,easingFunction:F.easing.easeInQuad,animationBase:0}}};A.prototype.renderScatter=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,c=0,f,g;d.save();u&&this._eventManager.ghostCtx.save();d.beginPath();d.rect(b.x1,b.y1,b.width,b.height);d.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(b.x1,
b.y1,b.width,b.height),this._eventManager.ghostCtx.clip());for(var h=0;h<a.dataSeriesIndexes.length;h++){var l=a.dataSeriesIndexes[h],k=this.data[l],n=k.dataPoints;if(0<n.length){d.strokeStyle="#4572A7 ";Math.pow(0.3*Math.min(b.height,b.width)/2,2);for(var m=0,p=0,c=0;c<n.length;c++)if(f=n[c].getTime?f=n[c].x.getTime():f=n[c].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof n[c].y){f=a.axisX.convertValueToPixel(f);g=a.axisY.convertValueToPixel(n[c].y);var e=k.getMarkerProperties(c,
f,g,d);d.globalAlpha=k.fillOpacity;O.drawMarker(e.x,e.y,e.ctx,e.type,e.size,e.color,e.borderColor,e.borderThickness);d.globalAlpha=1;Math.sqrt((m-f)*(m-f)+(p-g)*(p-g))<Math.min(e.size,5)&&n.length>Math.min(this.plotArea.width,this.plotArea.height)||(m=k.dataPointIds[c],this._eventManager.objectMap[m]={id:m,objectType:"dataPoint",dataSeriesIndex:l,dataPointIndex:c,x1:f,y1:g},m=G(m),u&&O.drawMarker(e.x,e.y,this._eventManager.ghostCtx,e.type,e.size,m,m,e.borderThickness),(n[c].indexLabel||k.indexLabel||
n[c].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"scatter",dataPoint:n[c],dataSeries:k,point:{x:f,y:g},direction:1,bounds:{x1:f-e.size/2,y1:g-e.size/2,x2:f+e.size/2,y2:g+e.size/2},color:null}),m=f,p=g)}}}d.restore();u&&this._eventManager.ghostCtx.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:F.fadeInAnimation,easingFunction:F.easing.easeInQuad,animationBase:0}}};A.prototype.renderCandlestick=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,
b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var c=null,c=this.plotArea,f=0,g,h,l,k,n,m,f=this.dataPointMinWidth?this.dataPointMinWidth:this.dataPointWidth?this.dataPointWidth:1;g=this.dataPointMaxWidth?this.dataPointMaxWidth:this.dataPointWidth?this.dataPointWidth:0.015*this.width;var p=a.axisX.dataInfo.minDiff;isFinite(p)||(p=0.3*Math.abs(a.axisX.range));p=this.dataPointWidth?this.dataPointWidth:0.7*c.width*(a.axisX.logarithmic?Math.log(p)/Math.log(a.axisX.range):Math.abs(p)/
Math.abs(a.axisX.range))<<0;this.dataPointMaxWidth&&f>g&&(f=Math.min(this.dataPointWidth?this.dataPointWidth:Infinity,g));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&g<f)&&(g=Math.max(this.dataPointWidth?this.dataPointWidth:-Infinity,f));p<f&&(p=f);p>g&&(p=g);d.save();u&&b.save();d.beginPath();d.rect(c.x1,c.y1,c.width,c.height);d.clip();u&&(b.beginPath(),b.rect(c.x1,c.y1,c.width,c.height),b.clip());for(var e=0;e<a.dataSeriesIndexes.length;e++){var q=a.dataSeriesIndexes[e],r=this.data[q],s=r.dataPoints;
if(0<s.length)for(var v=5<p&&r.bevelEnabled?!0:!1,f=0;f<s.length;f++)if(s[f].getTime?m=s[f].x.getTime():m=s[f].x,!(m<a.axisX.dataInfo.viewPortMin||m>a.axisX.dataInfo.viewPortMax)&&null!==s[f].y&&s[f].y.length&&"number"===typeof s[f].y[0]&&"number"===typeof s[f].y[1]&&"number"===typeof s[f].y[2]&&"number"===typeof s[f].y[3]){g=a.axisX.convertValueToPixel(m);h=a.axisY.convertValueToPixel(s[f].y[0]);l=a.axisY.convertValueToPixel(s[f].y[1]);k=a.axisY.convertValueToPixel(s[f].y[2]);n=a.axisY.convertValueToPixel(s[f].y[3]);
var w=g-p/2<<0,y=w+p<<0,c=s[f].color?s[f].color:r._colorSet[0],t=Math.round(Math.max(1,0.15*p)),x=0===t%2?0:0.5,z=r.dataPointIds[f];this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:w,y1:h,x2:y,y2:l,x3:g,y3:k,x4:g,y4:n,borderThickness:t,color:c};d.strokeStyle=c;d.beginPath();d.lineWidth=t;b.lineWidth=Math.max(t,4);"candlestick"===r.type?(d.moveTo(g-x,l),d.lineTo(g-x,Math.min(h,n)),d.stroke(),d.moveTo(g-x,Math.max(h,n)),d.lineTo(g-x,k),d.stroke(),N(d,
w,Math.min(h,n),y,Math.max(h,n),s[f].y[0]<=s[f].y[3]?r.risingColor:c,t,c,v,v,!1,!1,r.fillOpacity),u&&(c=G(z),b.strokeStyle=c,b.moveTo(g-x,l),b.lineTo(g-x,Math.min(h,n)),b.stroke(),b.moveTo(g-x,Math.max(h,n)),b.lineTo(g-x,k),b.stroke(),N(b,w,Math.min(h,n),y,Math.max(h,n),c,0,null,!1,!1,!1,!1))):"ohlc"===r.type&&(d.moveTo(g-x,l),d.lineTo(g-x,k),d.stroke(),d.beginPath(),d.moveTo(g,h),d.lineTo(w,h),d.stroke(),d.beginPath(),d.moveTo(g,n),d.lineTo(y,n),d.stroke(),u&&(c=G(z),b.strokeStyle=c,b.moveTo(g-x,
l),b.lineTo(g-x,k),b.stroke(),b.beginPath(),b.moveTo(g,h),b.lineTo(w,h),b.stroke(),b.beginPath(),b.moveTo(g,n),b.lineTo(y,n),b.stroke()));(s[f].indexLabel||r.indexLabel||s[f].indexLabelFormatter||r.indexLabelFormatter)&&this._indexLabels.push({chartType:r.type,dataPoint:s[f],dataSeries:r,point:{x:w+(y-w)/2,y:a.axisY.reversed?k:l},direction:1,bounds:{x1:w,y1:Math.min(l,k),x2:y,y2:Math.max(l,k)},color:c})}}d.restore();u&&b.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:F.fadeInAnimation,
easingFunction:F.easing.easeInQuad,animationBase:0}}};A.prototype.renderRangeColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var b=null,c=this.plotArea,f=0,g,h,f=this.dataPointMinWidth?this.dataPointMinWidth:this.dataPointWidth?this.dataPointWidth:1;g=this.dataPointMaxWidth?this.dataPointMaxWidth:this.dataPointWidth?this.dataPointWidth:0.03*this.width;var l=a.axisX.dataInfo.minDiff;isFinite(l)||(l=0.3*Math.abs(a.axisX.range));l=this.dataPointWidth?
this.dataPointWidth:0.9*(c.width*(a.axisX.logarithmic?Math.log(l)/Math.log(a.axisX.range):Math.abs(l)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>g&&(f=Math.min(this.dataPointWidth?this.dataPointWidth:Infinity,g));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&g<f)&&(g=Math.max(this.dataPointWidth?this.dataPointWidth:-Infinity,f));l<f&&(l=f);l>g&&(l=g);d.save();u&&this._eventManager.ghostCtx.save();d.beginPath();d.rect(c.x1,c.y1,c.width,c.height);d.clip();
...
a.axisX.convertValueToPixel(h);c=a.axisY.convertValueToPixel(p[f].y[0]);g=a.axisY.convertValueToPixel(p[f].y[1]);var q=a.axisX.reversed?b+a.plotType.totalDataSeries*l/2-(a.previousDataSeriesCount+k)*l<<0:b-a.plotType.totalDataSeries*l/2+(a.previousDataSeriesCount+k)*l<<0,r=a.axisX.reversed?q-l<<0:q+l<<0,b=p[f].color?p[f].color:m._colorSet[f%m._colorSet.length];if(c>g){var s=c,c=g;g=s}s=m.dataPointIds[f];this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:f,
x1:q,y1:c,x2:r,y2:g};N(d,q,c,r,g,b,0,b,e,e,!1,!1,m.fillOpacity);b=G(s);u&&N(this._eventManager.ghostCtx,q,c,r,g,b,0,null,!1,!1,!1,!1);if(p[f].indexLabel||m.indexLabel||p[f].indexLabelFormatter||m.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:p[f],dataSeries:m,indexKeyword:0,point:{x:q+(r-q)/2,y:p[f].y[1]>=p[f].y[0]?g:c},direction:p[f].y[1]>=p[f].y[0]?-1:1,bounds:{x1:q,y1:Math.min(c,g),x2:r,y2:Math.max(c,g)},color:b}),this._indexLabels.push({chartType:"rangeColumn",
dataPoint:p[f],dataSeries:m,indexKeyword:1,point:{x:q+(r-q)/2,y:p[f].y[1]>=p[f].y[0]?c:g},direction:p[f].y[1]>=p[f].y[0]?1:-1,bounds:{x1:q,y1:Math.min(c,g),x2:r,y2:Math.max(c,g)},color:b})}}d.restore();u&&this._eventManager.ghostCtx.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:F.fadeInAnimation,easingFunction:F.easing.easeInQuad,animationBase:0}}};A.prototype.renderRangeBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var b=null,
c=this.plotArea,f=0,g,h,l,f=this.dataPointMinWidth?this.dataPointMinWidth:this.dataPointWidth?this.dataPointWidth:1;g=this.dataPointMaxWidth?this.dataPointMaxWidth:this.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.height,0.9*(this.plotArea.height/a.plotType.totalDataSeries))<<0;var k=a.axisX.dataInfo.minDiff;isFinite(k)||(k=0.3*Math.abs(a.axisX.range));k=this.dataPointWidth?this.dataPointWidth:0.9*(c.height*(a.axisX.logarithmic?Math.log(k)/Math.log(a.axisX.range):Math.abs(k)/Math.abs(a.axisX.range))/
a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>g&&(f=Math.min(this.dataPointWidth?this.dataPointWidth:Infinity,g));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&g<f)&&(g=Math.max(this.dataPointWidth?this.dataPointWidth:-Infinity,f));k<f&&(k=f);k>g&&(k=g);d.save();u&&this._eventManager.ghostCtx.save();d.beginPath();d.rect(c.x1,c.y1,c.width,c.height);d.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(c.x1,c.y1,c.width,c.height),this._eventManager.ghostCtx.clip());
for(var n=0;n<a.dataSeriesIndexes.length;n++){var m=a.dataSeriesIndexes[n],p=this.data[m],e=p.dataPoints;if(0<e.length){var q=5<k&&p.bevelEnabled?!0:!1;d.strokeStyle="#4572A7 ";for(f=0;f<e.length;f++)if(e[f].getTime?l=e[f].x.getTime():l=e[f].x,!(l<a.axisX.dataInfo.viewPortMin||l>a.axisX.dataInfo.viewPortMax)&&null!==e[f].y&&e[f].y.length&&"number"===typeof e[f].y[0]&&"number"===typeof e[f].y[1]){c=a.axisY.convertValueToPixel(e[f].y[0]);g=a.axisY.convertValueToPixel(e[f].y[1]);h=a.axisX.convertValueToPixel(l);
h=a.axisX.reversed?h+a.plotType.totalDataSeries*k/2-(a.previousDataSeriesCount+n)*k<<0:h-a.plotType.totalDataSeries*k/2+(a.previousDataSeriesCount+n)*k<<0;var r=a.axisX.reversed?h-k<<0:h+k<<0;c>g&&(b=c,c=g,g=b);b=e[f].color?e[f].color:p._colorSet[f%p._colorSet.length];N(d,c,h,g,r,b,0,null,q,!1,!1,!1,p.fillOpacity);b=p.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:f,x1:c,y1:h,x2:g,y2:r};b=G(b);u&&N(this._eventManager.ghostCtx,c,h,g,r,
b,0,null,!1,!1,!1,!1);if(e[f].indexLabel||p.indexLabel||e[f].indexLabelFormatter||p.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:e[f],dataSeries:p,indexKeyword:0,point:{x:e[f].y[1]>=e[f].y[0]?c:g,y:h+(r-h)/2},direction:e[f].y[1]>=e[f].y[0]?-1:1,bounds:{x1:Math.min(c,g),y1:h,x2:Math.max(c,g),y2:r},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:e[f],dataSeries:p,indexKeyword:1,point:{x:e[f].y[1]>=e[f].y[0]?g:c,y:h+(r-h)/2},direction:e[f].y[1]>=e[f].y[0]?
1:-1,bounds:{x1:Math.min(c,g),y1:h,x2:Math.max(c,g),y2:r},color:b})}}}d.restore();u&&this._eventManager.ghostCtx.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:F.fadeInAnimation,easingFunction:F.easing.easeInQuad,animationBase:0}}};A.prototype.renderRangeArea=function(a){function d(){if(w){var a=null;0<n.lineThickness&&b.stroke();for(var d=l.length-1;0<=d;d--)a=l[d],b.lineTo(a.x,a.y),c.lineTo(a.x,a.y);b.closePath();b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;c.fill();
if(0<n.lineThickness){b.beginPath();b.moveTo(a.x,a.y);for(d=0;d<l.length;d++)a=l[d],b.lineTo(a.x,a.y);b.stroke()}b.beginPath();b.moveTo(q,r);c.beginPath();c.moveTo(q,r);w={x:q,y:r};l=[];l.push({x:q,y:s})}}var b=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var c=this._eventManager.ghostCtx,f=[],g=null,h=this.plotArea;b.save();u&&c.save();b.beginPath();b.rect(h.x1,h.y1,h.width,h.height);b.clip();u&&(c.beginPath(),c.rect(h.x1,h.y1,h.width,h.height),c.clip());for(h=0;h<a.dataSeriesIndexes.length;h++){var l=
[],k=a.dataSeriesIndexes[h],n=this.data[k],m=n.dataPoints,f=n.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=G(f);c.fillStyle=f;var f=[],p=!0,e=0,q,r,s,v,w=null;if(0<m.length){var y=n._colorSet[e%n._colorSet.length],t=n.lineColor=n.options.lineColor||y,x=t;b.fillStyle=y;b.strokeStyle=t;b.lineWidth=n.lineThickness;var z="solid";if(b.setLineDash){var A=I(n.nullDataLineDashType,n.lineThickness),z=n.lineDashType,B=I(z,n.lineThickness);b.setLineDash(B)}for(var E=!0;e<
m.length;e++)if(v=m[e].x.getTime?m[e].x.getTime():m[e].x,!(v<a.axisX.dataInfo.viewPortMin||v>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!E)))if(null!==m[e].y&&m[e].y.length&&"number"===typeof m[e].y[0]&&"number"===typeof m[e].y[1]){q=a.axisX.convertValueToPixel(v);r=a.axisY.convertValueToPixel(m[e].y[0]);s=a.axisY.convertValueToPixel(m[e].y[1]);p||E?(n.connectNullData&&!p?(b.setLineDash&&(n.options.nullDataLineDashType||z===n.lineDashType&&n.lineDashType!==n.nullDataLineDashType)&&(l[l.length-
1].newLineDashArray=B,z=n.nullDataLineDashType,b.setLineDash(A)),b.lineTo(q,r),u&&c.lineTo(q,r),l.push({x:q,y:s})):(b.beginPath(),b.moveTo(q,r),w={x:q,y:r},l=[],l.push({x:q,y:s}),u&&(c.beginPath(),c.moveTo(q,r))),E=p=!1):(b.lineTo(q,r),l.push({x:q,y:s}),u&&c.lineTo(q,r),0==e%250&&d());v=n.dataPointIds[e];this._eventManager.objectMap[v]={id:v,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:e,x1:q,y1:r,y2:s};e<m.length-1&&(x!==(m[e].lineColor||t)||z!==(m[e].lineDashType||n.lineDashType))&&(d(),
x=m[e].lineColor||t,l[l.length-1].newStrokeStyle=x,b.strokeStyle=x,b.setLineDash&&(m[e].lineDashType?(z=m[e].lineDashType,l[l.length-1].newLineDashArray=I(z,n.lineThickness),b.setLineDash(l[l.length-1].newLineDashArray)):(z=n.lineDashType,l[l.length-1].newLineDashArray=B,b.setLineDash(B))));if(0!==m[e].markerSize&&(0<m[e].markerSize||0<n.markerSize)){var R=n.getMarkerProperties(e,q,s,b);f.push(R);var J=G(v);u&&f.push({x:q,y:s,ctx:c,type:R.type,size:R.size,color:J,borderColor:J,borderThickness:R.borderThickness});
R=n.getMarkerProperties(e,q,r,b);g=R.color;f.push(R);J=G(v);u&&f.push({x:q,y:r,ctx:c,type:R.type,size:R.size,color:J,borderColor:J,borderThickness:R.borderThickness})}if(m[e].indexLabel||n.indexLabel||m[e].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:m[e],dataSeries:n,indexKeyword:0,point:{x:q,y:r},direction:m[e].y[0]>m[e].y[1]===a.axisY.reversed?-1:1,color:y}),this._indexLabels.push({chartType:"rangeArea",dataPoint:m[e],dataSeries:n,indexKeyword:1,
point:{x:q,y:s},direction:m[e].y[0]>m[e].y[1]===a.axisY.reversed?1:-1,color:y})}else E||p||d(),E=!0;d();O.drawMarkers(f);n.markerColor=g}}b.restore();u&&this._eventManager.ghostCtx.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:F.xClipAnimation,easingFunction:F.easing.linear,animationBase:0}}};A.prototype.renderRangeSplineArea=function(a){function d(a,d){var e=ua(r,2);if(0<e.length){if(0<k.lineThickness){b.strokeStyle=d;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(e[0].x,
...
e[f+3].y),u&&c.bezierCurveTo(e[f+1].x,e[f+1].y,e[f+2].x,e[f+2].y,e[f+3].x,e[f+3].y);e=ua(s,2);b.lineTo(s[s.length-1].x,s[s.length-1].y);for(f=e.length-1;2<f;f-=3)b.bezierCurveTo(e[f-1].x,e[f-1].y,e[f-2].x,e[f-2].y,e[f-3].x,e[f-3].y),u&&c.bezierCurveTo(e[f-1].x,e[f-1].y,e[f-2].x,e[f-2].y,e[f-3].x,e[f-3].y);b.closePath();b.globalAlpha=k.fillOpacity;b.fill();u&&(c.closePath(),c.fill());b.globalAlpha=1;if(0<k.lineThickness){b.strokeStyle=d;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(e[0].x,
e[0].y);for(var g=f=0;f<e.length-3;f+=3,g++){if(r[g].newStrokeStyle||r[g].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(e[f].x,e[f].y),r[g].newStrokeStyle&&(b.strokeStyle=r[g].newStrokeStyle),r[g].newLineDashArray&&b.setLineDash(r[g].newLineDashArray);b.bezierCurveTo(e[f+1].x,e[f+1].y,e[f+2].x,e[f+2].y,e[f+3].x,e[f+3].y)}b.stroke()}b.beginPath()}}var b=a.targetCanvasCtx||this.plotArea.ctx;if(!(0>=a.dataSeriesIndexes.length)){var c=this._eventManager.ghostCtx,f=[],g=null,h=this.plotArea;b.save();
u&&c.save();b.beginPath();b.rect(h.x1,h.y1,h.width,h.height);b.clip();u&&(c.beginPath(),c.rect(h.x1,h.y1,h.width,h.height),c.clip());for(h=0;h<a.dataSeriesIndexes.length;h++){var l=a.dataSeriesIndexes[h],k=this.data[l],n=k.dataPoints,f=k.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:l};f=G(f);c.fillStyle=f;var f=[],m=0,p,e,q,r=[],s=[];if(0<n.length){var v=k._colorSet[m%k._colorSet.length],w=k.lineColor=k.options.lineColor||v,y=w;b.fillStyle=v;b.lineWidth=k.lineThickness;
var t="solid",x;if(b.setLineDash){var z=I(k.nullDataLineDashType,k.lineThickness),t=k.lineDashType;x=I(t,k.lineThickness)}for(e=!1;m<n.length;m++)if(p=n[m].x.getTime?n[m].x.getTime():n[m].x,!(p<a.axisX.dataInfo.viewPortMin||p>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!e)))if(null!==n[m].y&&n[m].y.length&&"number"===typeof n[m].y[0]&&"number"===typeof n[m].y[1]){p=a.axisX.convertValueToPixel(p);e=a.axisY.convertValueToPixel(n[m].y[0]);q=a.axisY.convertValueToPixel(n[m].y[1]);var A=k.dataPointIds[m];
this._eventManager.objectMap[A]={id:A,objectType:"dataPoint",dataSeriesIndex:l,dataPointIndex:m,x1:p,y1:e,y2:q};r[r.length]={x:p,y:e};s[s.length]={x:p,y:q};m<n.length-1&&(y!==(n[m].lineColor||w)||t!==(n[m].lineDashType||k.lineDashType))&&(y=n[m].lineColor||w,r[r.length-1].newStrokeStyle=y,b.setLineDash&&(n[m].lineDashType?(t=n[m].lineDashType,r[r.length-1].newLineDashArray=I(t,k.lineThickness)):(t=k.lineDashType,r[r.length-1].newLineDashArray=x)));if(0!==n[m].markerSize&&(0<n[m].markerSize||0<k.markerSize)){var B=
k.getMarkerProperties(m,p,e,b),g=B.color;f.push(B);var E=G(A);u&&f.push({x:p,y:e,ctx:c,type:B.type,size:B.size,color:E,borderColor:E,borderThickness:B.borderThickness});B=k.getMarkerProperties(m,p,q,b);f.push(B);E=G(A);u&&f.push({x:p,y:q,ctx:c,type:B.type,size:B.size,color:E,borderColor:E,borderThickness:B.borderThickness})}if(n[m].indexLabel||k.indexLabel||n[m].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"splineArea",dataPoint:n[m],dataSeries:k,indexKeyword:0,point:{x:p,
y:e},direction:n[m].y[0]<=n[m].y[1]?-1:1,color:v}),this._indexLabels.push({chartType:"splineArea",dataPoint:n[m],dataSeries:k,indexKeyword:1,point:{x:p,y:q},direction:n[m].y[0]<=n[m].y[1]?1:-1,color:v});e=!1}else 0<m&&!e&&(k.connectNullData?b.setLineDash&&(0<r.length&&(k.options.nullDataLineDashType||!n[m-1].lineDashType))&&(r[r.length-1].newLineDashArray=z,t=k.nullDataLineDashType):(d(x,w),r=[],s=[])),e=!0;d(x,w);O.drawMarkers(f);k.markerColor=g}}b.restore();u&&this._eventManager.ghostCtx.restore();
return{source:b,dest:this.plotArea.ctx,animationCallback:F.xClipAnimation,easingFunction:F.easing.linear,animationBase:0}}};var Ga=function(a,d,b,c,f,g,h,l,k){if(!(0>b)){"undefined"===typeof l&&(l=1);if(!u){var n=Number((h%(2*Math.PI)).toFixed(8));Number((g%(2*Math.PI)).toFixed(8))===n&&(h-=1E-4)}a.save();a.globalAlpha=l;"pie"===f?(a.beginPath(),a.moveTo(d.x,d.y),a.arc(d.x,d.y,b,g,h,!1),a.fillStyle=c,a.strokeStyle="white",a.lineWidth=2,a.closePath(),a.fill()):"doughnut"===f&&(a.beginPath(),a.arc(d.x,
d.y,b,g,h,!1),0<=k&&a.arc(d.x,d.y,k*b,h,g,!0),a.closePath(),a.fillStyle=c,a.strokeStyle="white",a.lineWidth=2,a.fill());a.globalAlpha=1;a.restore()}};A.prototype.renderPie=function(a){function d(){if(n&&m){for(var a=0,b=0,c=0,d=0,f=0;f<m.length;f++){var g=m[f],h=n.dataPointIds[f],l={id:h,objectType:"dataPoint",dataPointIndex:f,dataSeriesIndex:0};q.push(l);var p={percent:null,total:null},r=null,p=k.getPercentAndTotal(n,g);if(n.indexLabelFormatter||g.indexLabelFormatter)r={chart:k.options,dataSeries:n,
dataPoint:g,total:p.total,percent:p.percent};p=g.indexLabelFormatter?g.indexLabelFormatter(r):g.indexLabel?k.replaceKeywordsWithValue(g.indexLabel,g,n,f):n.indexLabelFormatter?n.indexLabelFormatter(r):n.indexLabel?k.replaceKeywordsWithValue(n.indexLabel,g,n,f):g.label?g.label:"";k._eventManager.objectMap[h]=l;l.center={x:t.x,y:t.y};l.y=g.y;l.radius=B;l.percentInnerRadius=F;l.indexLabelText=p;l.indexLabelPlacement=n.indexLabelPlacement;l.indexLabelLineColor=g.indexLabelLineColor?g.indexLabelLineColor:
n.options.indexLabelLineColor?n.options.indexLabelLineColor:g.color?g.color:n._colorSet[f%n._colorSet.length];l.indexLabelLineThickness=x(g.indexLabelLineThickness)?n.indexLabelLineThickness:g.indexLabelLineThickness;l.indexLabelLineDashType=g.indexLabelLineDashType?g.indexLabelLineDashType:n.indexLabelLineDashType;l.indexLabelFontColor=g.indexLabelFontColor?g.indexLabelFontColor:n.indexLabelFontColor;l.indexLabelFontStyle=g.indexLabelFontStyle?g.indexLabelFontStyle:n.indexLabelFontStyle;l.indexLabelFontWeight=
g.indexLabelFontWeight?g.indexLabelFontWeight:n.indexLabelFontWeight;l.indexLabelFontSize=g.indexLabelFontSize?g.indexLabelFontSize:n.indexLabelFontSize;l.indexLabelFontFamily=g.indexLabelFontFamily?g.indexLabelFontFamily:n.indexLabelFontFamily;l.indexLabelBackgroundColor=g.indexLabelBackgroundColor?g.indexLabelBackgroundColor:n.options.indexLabelBackgroundColor?n.options.indexLabelBackgroundColor:n.indexLabelBackgroundColor;l.indexLabelMaxWidth=g.indexLabelMaxWidth?g.indexLabelMaxWidth:n.indexLabelMaxWidth?
n.indexLabelMaxWidth:0.33*e.width;l.indexLabelWrap="undefined"!==typeof g.indexLabelWrap?g.indexLabelWrap:n.indexLabelWrap;l.startAngle=0===f?n.startAngle?n.startAngle/180*Math.PI:0:q[f-1].endAngle;l.startAngle=(l.startAngle+2*Math.PI)%(2*Math.PI);l.endAngle=l.startAngle+2*Math.PI/u*Math.abs(g.y);g=(l.endAngle+l.startAngle)/2;g=(g+2*Math.PI)%(2*Math.PI);l.midAngle=g;if(l.midAngle>Math.PI/2-w&&l.midAngle<Math.PI/2+w){if(0===a||q[c].midAngle>l.midAngle)c=f;a++}else if(l.midAngle>3*Math.PI/2-w&&l.midAngle<
3*Math.PI/2+w){if(0===b||q[d].midAngle>l.midAngle)d=f;b++}l.hemisphere=g>Math.PI/2&&g<=3*Math.PI/2?"left":"right";l.indexLabelTextBlock=new W(k.plotArea.ctx,{fontSize:l.indexLabelFontSize,fontFamily:l.indexLabelFontFamily,fontColor:l.indexLabelFontColor,fontStyle:l.indexLabelFontStyle,fontWeight:l.indexLabelFontWeight,horizontalAlign:"left",backgroundColor:l.indexLabelBackgroundColor,maxWidth:l.indexLabelMaxWidth,maxHeight:l.indexLabelWrap?5*l.indexLabelFontSize:1.5*l.indexLabelFontSize,text:l.indexLabelText,
padding:0,textBaseline:"top"});l.indexLabelTextBlock.measureText()}h=g=0;p=!1;for(f=0;f<m.length;f++)l=q[(c+f)%m.length],1<a&&(l.midAngle>Math.PI/2-w&&l.midAngle<Math.PI/2+w)&&(g<=a/2&&!p?(l.hemisphere="right",g++):(l.hemisphere="left",p=!0));p=!1;for(f=0;f<m.length;f++)l=q[(d+f)%m.length],1<b&&(l.midAngle>3*Math.PI/2-w&&l.midAngle<3*Math.PI/2+w)&&(h<=b/2&&!p?(l.hemisphere="left",h++):(l.hemisphere="right",p=!0))}}function b(a){var b=k.plotArea.ctx;b.clearRect(e.x1,e.y1,e.width,e.height);b.fillStyle=
k.backgroundColor;b.fillRect(e.x1,e.y1,e.width,e.height);for(b=0;b<m.length;b++){var c=q[b].startAngle,d=q[b].endAngle;if(d>c){var f=0.07*B*Math.cos(q[b].midAngle),g=0.07*B*Math.sin(q[b].midAngle),l=!1;if(m[b].exploded){if(1E-9<Math.abs(q[b].center.x-(t.x+f))||1E-9<Math.abs(q[b].center.y-(t.y+g)))q[b].center.x=t.x+f*a,q[b].center.y=t.y+g*a,l=!0}else if(0<Math.abs(q[b].center.x-t.x)||0<Math.abs(q[b].center.y-t.y))q[b].center.x=t.x+f*(1-a),q[b].center.y=t.y+g*(1-a),l=!0;l&&(f={},f.dataSeries=n,f.dataPoint=
n.dataPoints[b],f.index=b,k.toolTip.highlightObjects([f]));Ga(k.plotArea.ctx,q[b].center,q[b].radius,m[b].color?m[b].color:n._colorSet[b%n._colorSet.length],n.type,c,d,n.fillOpacity,q[b].percentInnerRadius)}}a=k.plotArea.ctx;a.save();a.fillStyle="black";a.strokeStyle="grey";a.textBaseline="middle";a.lineJoin="round";for(b=b=0;b<m.length;b++)c=q[b],c.indexLabelText&&(c.indexLabelTextBlock.y-=c.indexLabelTextBlock.height/2,d=0,d="left"===c.hemisphere?"inside"!==n.indexLabelPlacement?-(c.indexLabelTextBlock.width+
p):-c.indexLabelTextBlock.width/2:"inside"!==n.indexLabelPlacement?p:-c.indexLabelTextBlock.width/2,c.indexLabelTextBlock.x+=d,c.indexLabelTextBlock.render(!0),c.indexLabelTextBlock.x-=d,c.indexLabelTextBlock.y+=c.indexLabelTextBlock.height/2,"inside"!==c.indexLabelPlacement&&0<c.indexLabelLineThickness&&(d=c.center.x+B*Math.cos(c.midAngle),f=c.center.y+B*Math.sin(c.midAngle),a.strokeStyle=c.indexLabelLineColor,a.lineWidth=c.indexLabelLineThickness,a.setLineDash&&a.setLineDash(I(c.indexLabelLineDashType,
c.indexLabelLineThickness)),a.beginPath(),a.moveTo(d,f),a.lineTo(c.indexLabelTextBlock.x,c.indexLabelTextBlock.y),a.lineTo(c.indexLabelTextBlock.x+("left"===c.hemisphere?-p:p),c.indexLabelTextBlock.y),a.stroke()),a.lineJoin="miter");a.save()}function c(a,b){var c=0,c=a.indexLabelTextBlock.y-a.indexLabelTextBlock.height/2,d=a.indexLabelTextBlock.y+a.indexLabelTextBlock.height/2,e=b.indexLabelTextBlock.y-b.indexLabelTextBlock.height/2,f=b.indexLabelTextBlock.y+b.indexLabelTextBlock.height/2;return c=
b.indexLabelTextBlock.y>a.indexLabelTextBlock.y?e-d:c-f}function f(a){for(var b=null,d=1;d<m.length;d++)if(b=(a+d+q.length)%q.length,q[b].hemisphere!==q[a].hemisphere){b=null;break}else if(q[b].indexLabelText&&b!==a&&(0>c(q[b],q[a])||("right"===q[a].hemisphere?q[b].indexLabelTextBlock.y>=q[a].indexLabelTextBlock.y:q[b].indexLabelTextBlock.y<=q[a].indexLabelTextBlock.y)))break;else b=null;return b}function g(a,b,d){d=(d||0)+1;if(1E3<d)return 0;b=b||0;var e=0,k=t.y-1*s,l=t.y+1*s;if(0<=a&&a<m.length){var h=
q[a];if(0>b&&h.indexLabelTextBlock.y<k||0<b&&h.indexLabelTextBlock.y>l)return 0;var p=0,n=0,n=p=p=0;0>b?h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2>k&&h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2+b<k&&(b=-(k-(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2+b))):h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2<k&&h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2+b>l&&(b=h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2+b-l);b=h.indexLabelTextBlock.y+b;k=
0;k="right"===h.hemisphere?t.x+Math.sqrt(Math.pow(s,2)-Math.pow(b-t.y,2)):t.x-Math.sqrt(Math.pow(s,2)-Math.pow(b-t.y,2));n=t.x+B*Math.cos(h.midAngle);p=t.y+B*Math.sin(h.midAngle);p=Math.sqrt(Math.pow(k-n,2)+Math.pow(b-p,2));n=Math.acos(B/s);p=Math.acos((s*s+B*B-p*p)/(2*B*s));b=p<n?b-h.indexLabelTextBlock.y:0;k=null;for(l=1;l<m.length;l++)if(k=(a-l+q.length)%q.length,q[k].hemisphere!==q[a].hemisphere){k=null;break}else if(q[k].indexLabelText&&q[k].hemisphere===q[a].hemisphere&&k!==a&&(0>c(q[k],q[a])||
("right"===q[a].hemisphere?q[k].indexLabelTextBlock.y<=q[a].indexLabelTextBlock.y:q[k].indexLabelTextBlock.y>=q[a].indexLabelTextBlock.y)))break;else k=null;n=k;p=f(a);l=k=0;0>b?(l="right"===h.hemisphere?n:p,e=b,null!==l&&(n=-b,b=h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-(q[l].indexLabelTextBlock.y+q[l].indexLabelTextBlock.height/2),b-n<r&&(k=-n,l=g(l,k,d+1),+l.toFixed(y)>+k.toFixed(y)&&(e=b>r?-(b-r):-(n-(l-k)))))):0<b&&(l="right"===h.hemisphere?p:n,e=b,null!==l&&(n=b,b=q[l].indexLabelTextBlock.y-
q[l].indexLabelTextBlock.height/2-(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2),b-n<r&&(k=n,l=g(l,k,d+1),+l.toFixed(y)<+k.toFixed(y)&&(e=b>r?b-r:n-(k-l)))));e&&(d=h.indexLabelTextBlock.y+e,b=0,b="right"===h.hemisphere?t.x+Math.sqrt(Math.pow(s,2)-Math.pow(d-t.y,2)):t.x-Math.sqrt(Math.pow(s,2)-Math.pow(d-t.y,2)),h.midAngle>Math.PI/2-w&&h.midAngle<Math.PI/2+w?(k=(a-1+q.length)%q.length,k=q[k],a=q[(a+1+q.length)%q.length],"left"===h.hemisphere&&"right"===k.hemisphere&&b>k.indexLabelTextBlock.x?
b=k.indexLabelTextBlock.x-15:"right"===h.hemisphere&&("left"===a.hemisphere&&b<a.indexLabelTextBlock.x)&&(b=a.indexLabelTextBlock.x+15)):h.midAngle>3*Math.PI/2-w&&h.midAngle<3*Math.PI/2+w&&(k=(a-1+q.length)%q.length,k=q[k],a=q[(a+1+q.length)%q.length],"right"===h.hemisphere&&"left"===k.hemisphere&&b<k.indexLabelTextBlock.x?b=k.indexLabelTextBlock.x+15:"left"===h.hemisphere&&("right"===a.hemisphere&&b>a.indexLabelTextBlock.x)&&(b=a.indexLabelTextBlock.x-15)),h.indexLabelTextBlock.y=d,h.indexLabelTextBlock.x=
b,h.indexLabelAngle=Math.atan2(h.indexLabelTextBlock.y-t.y,h.indexLabelTextBlock.x-t.x))}return e}function h(){var a=k.plotArea.ctx;a.fillStyle="grey";a.strokeStyle="grey";a.font="16px Arial";a.textBaseline="middle";for(var b=a=0,d=0,l=!0,b=0;10>b&&(1>b||0<d);b++){if(n.radius||!n.radius&&"undefined"!==typeof n.innerRadius&&null!==n.innerRadius&&B-d<=E)l=!1;l&&(B-=d);d=0;if("inside"!==n.indexLabelPlacement){s=B*v;for(a=0;a<m.length;a++){var h=q[a];h.indexLabelTextBlock.x=t.x+s*Math.cos(h.midAngle);
h.indexLabelTextBlock.y=t.y+s*Math.sin(h.midAngle);h.indexLabelAngle=h.midAngle;h.radius=B;h.percentInnerRadius=F}for(var w,u,a=0;a<m.length;a++){var h=q[a],x=f(a);if(null!==x){w=q[a];u=q[x];var z=0,z=c(w,u)-r;if(0>z){for(var A=u=0,D=0;D<m.length;D++)D!==a&&q[D].hemisphere===h.hemisphere&&(q[D].indexLabelTextBlock.y<h.indexLabelTextBlock.y?u++:A++);u=z/(u+A||1)*A;var A=-1*(z-u),C=D=0;"right"===h.hemisphere?(D=g(a,u),A=-1*(z-D),C=g(x,A),+C.toFixed(y)<+A.toFixed(y)&&+D.toFixed(y)<=+u.toFixed(y)&&g(a,
-(A-C))):(D=g(x,u),A=-1*(z-D),C=g(a,A),+C.toFixed(y)<+A.toFixed(y)&&+D.toFixed(y)<=+u.toFixed(y)&&g(x,-(A-C)))}}}}else for(a=0;a<m.length;a++)h=q[a],s="pie"===n.type?0.7*B:0.8*B,x=t.x+s*Math.cos(h.midAngle),u=t.y+s*Math.sin(h.midAngle),h.indexLabelTextBlock.x=x,h.indexLabelTextBlock.y=u;for(a=0;a<m.length;a++)if(h=q[a],x=h.indexLabelTextBlock.measureText(),0!==x.height&&0!==x.width)x=x=0,"right"===h.hemisphere?(x=e.x2-(h.indexLabelTextBlock.x+h.indexLabelTextBlock.width+p),x*=-1):x=e.x1-(h.indexLabelTextBlock.x-
h.indexLabelTextBlock.width-p),0<x&&(!l&&h.indexLabelText&&(u="right"===h.hemisphere?e.x2-h.indexLabelTextBlock.x:h.indexLabelTextBlock.x-e.x1,0.3*h.indexLabelTextBlock.maxWidth>u?h.indexLabelText="":h.indexLabelTextBlock.maxWidth=0.85*u,0.3*h.indexLabelTextBlock.maxWidth<u&&(h.indexLabelTextBlock.x-="right"===h.hemisphere?2:-2)),Math.abs(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-t.y)<B||Math.abs(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2-t.y)<B)&&(x/=Math.abs(Math.cos(h.indexLabelAngle)),
9<x&&(x*=0.3),x>d&&(d=x)),x=x=0,0<h.indexLabelAngle&&h.indexLabelAngle<Math.PI?(x=e.y2-(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2+5),x*=-1):x=e.y1-(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-5),0<x&&(!l&&h.indexLabelText&&(u=0<h.indexLabelAngle&&h.indexLabelAngle<Math.PI?-1:1,0===g(a,x*u)&&g(a,2*u)),Math.abs(h.indexLabelTextBlock.x-t.x)<B&&(x/=Math.abs(Math.sin(h.indexLabelAngle)),9<x&&(x*=0.3),x>d&&(d=x)));var G=function(a,b,c){for(var d=[],e=0;d.push(q[b]),b!==c;b=(b+1+
m.length)%m.length);d.sort(function(a,b){return a.y-b.y});for(b=0;b<d.length;b++)if(c=d[b],e<0.7*a)e+=c.indexLabelTextBlock.height,c.indexLabelTextBlock.text="",c.indexLabelText="",c.indexLabelTextBlock.measureText();else break};(function(){for(var a=-1,b=-1,d=0,e=!1,g=0;g<m.length;g++)if(e=!1,w=q[g],w.indexLabelText){var h=f(g);if(null!==h){var k=q[h];z=0;z=c(w,k);var l;if(l=0>z){l=w.indexLabelTextBlock.x;var n=w.indexLabelTextBlock.y-w.indexLabelTextBlock.height/2,r=w.indexLabelTextBlock.y+w.indexLabelTextBlock.height/
2,s=k.indexLabelTextBlock.y-k.indexLabelTextBlock.height/2,t=k.indexLabelTextBlock.x+k.indexLabelTextBlock.width,v=k.indexLabelTextBlock.y+k.indexLabelTextBlock.height/2;l=w.indexLabelTextBlock.x+w.indexLabelTextBlock.width<k.indexLabelTextBlock.x-p||l>t+p||n>v+p||r<s-p?!1:!0}l?(0>a&&(a=g),h!==a&&(b=h,d+=-z),0===g%Math.max(m.length/10,3)&&(e=!0)):e=!0;e&&(0<d&&0<=a&&0<=b)&&(G(d,a,b),b=a=-1,d=0)}}0<d&&G(d,a,b)})()}}function l(){k.plotArea.layoutManager.reset();k.title&&(k.title.dockInsidePlotArea||
"center"===k.title.horizontalAlign&&"center"===k.title.verticalAlign)&&k.title.render();if(k.subtitles)for(var a=0;a<k.subtitles.length;a++){var b=k.subtitles[a];(b.dockInsidePlotArea||"center"===b.horizontalAlign&&"center"===b.verticalAlign)&&b.render()}k.legend&&(k.legend.dockInsidePlotArea||"center"===k.legend.horizontalAlign&&"center"===k.legend.verticalAlign)&&k.legend.render();z.fAWm&&z.fAWm(k);this.addEventListener("dataAnimationIterationEnd",function(){z.fNg&&z.fNg(k)})}var k=this;if(!(0>=
...
ja.prototype.reset=function(){this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding};U(W,M);W.prototype.render=function(a){a&&this.ctx.save();var d=this.ctx.font;this.ctx.textBaseline=this.textBaseline;var b=0;this._isDirty&&this.measureText(this.ctx);this.ctx.translate(this.x,this.y+b);"middle"===this.textBaseline&&(b=-this._lineHeight/2);this.ctx.font=this._getFontString();this.ctx.rotate(Math.PI/180*this.angle);var c=0,f=this.padding,g=null;(0<this.borderThickness&&
this.borderColor||this.backgroundColor)&&this.ctx.roundRect(0,b,this.width,this.height,this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor);this.ctx.fillStyle=this.fontColor;for(b=0;b<this._wrappedText.lines.length;b++)g=this._wrappedText.lines[b],"right"===this.horizontalAlign?c=this.width-g.width-this.padding:"left"===this.horizontalAlign?c=this.padding:"center"===this.horizontalAlign&&(c=(this.width-2*this.padding)/2-g.width/2+this.padding),this.ctx.fillText(g.text,c,f),
f+=g.height;this.ctx.font=d;a&&this.ctx.restore()};W.prototype.setText=function(a){this.text=a;this._isDirty=!0;this._wrappedText=null};W.prototype.measureText=function(){this._lineHeight=Ja(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};W.prototype._getLineWithWidth=function(a,d,b){a=String(a);if(!a)return{text:"",width:0};var c=b=0,f=
a.length-1,g=Infinity;for(this.ctx.font=this._getFontString();c<=f;){var g=Math.floor((c+f)/2),h=a.substr(0,g+1);b=this.ctx.measureText(h).width;if(b<d)c=g+1;else if(b>d)f=g-1;else break}b>d&&1<h.length&&(h=h.substr(0,h.length-1),b=this.ctx.measureText(h).width);d=!0;if(h.length===a.length||" "===a[h.length])d=!1;d&&(a=h.split(" "),1<a.length&&a.pop(),h=a.join(" "),b=this.ctx.measureText(h).width);return{text:h,width:b}};W.prototype._wrapText=function(){var a=new String(ka(String(this.text))),d=[],
b=this.ctx.font,c=0,f=0;for(this.ctx.font=this._getFontString();0<a.length;){var g=this.maxHeight-2*this.padding,h=this._getLineWithWidth(a,this.maxWidth-2*this.padding,!1);h.height=this._lineHeight;d.push(h);var l=f,f=Math.max(f,h.width),c=c+h.height,a=ka(a.slice(h.text.length,a.length));g&&c>g&&(h=d.pop(),c-=h.height,f=l)}this._wrappedText={lines:d,width:f,height:c};this.width=f+2*this.padding;this.height=c+2*this.padding;this.ctx.font=b};W.prototype._getFontString=function(){var a;a=""+(this.fontStyle?
this.fontStyle+" ":"");a+=this.fontWeight?this.fontWeight+" ":"";a+=this.fontSize?this.fontSize+"px ":"";var d=this.fontFamily?this.fontFamily+"":"";!u&&d&&(d=d.split(",")[0],"'"!==d[0]&&'"'!==d[0]&&(d="'"+d+"'"));return a+=d};U(ma,M);ma.prototype.render=function(){if(this.text){var a=this.dockInsidePlotArea?this.chart.plotArea:this.chart,d=a.layoutManager.getFreeSpace(),b=d.x1,c=d.y1,f=0,g=0,h=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,l,k;"top"===this.verticalAlign||
"bottom"===this.verticalAlign?(null===this.maxWidth&&(this.maxWidth=d.width-4-h*("center"===this.horizontalAlign?2:1)),g=0.5*d.height-this.margin-2,f=0):"center"===this.verticalAlign&&("left"===this.horizontalAlign||"right"===this.horizontalAlign?(null===this.maxWidth&&(this.maxWidth=d.height-4),g=0.5*d.width-this.margin-2):"center"===this.horizontalAlign&&(null===this.maxWidth&&(this.maxWidth=d.width-4),g=0.5*d.height-4));this.wrap||(g=Math.min(g,Math.max(1.5*this.fontSize,this.fontSize+2.5*this.padding)));
var g=new W(this.ctx,{fontSize:this.fontSize,fontFamily:this.fontFamily,fontColor:this.fontColor,fontStyle:this.fontStyle,fontWeight:this.fontWeight,horizontalAlign:this.horizontalAlign,verticalAlign:this.verticalAlign,borderColor:this.borderColor,borderThickness:this.borderThickness,backgroundColor:this.backgroundColor,maxWidth:this.maxWidth,maxHeight:g,cornerRadius:this.cornerRadius,text:this.text,padding:this.padding,textBaseline:"top"}),n=g.measureText();"top"===this.verticalAlign||"bottom"===
this.verticalAlign?("top"===this.verticalAlign?(c=d.y1+2,k="top"):"bottom"===this.verticalAlign&&(c=d.y2-2-n.height,k="bottom"),"left"===this.horizontalAlign?b=d.x1+2:"center"===this.horizontalAlign?b=d.x1+d.width/2-n.width/2:"right"===this.horizontalAlign&&(b=d.x2-2-n.width-h),l=this.horizontalAlign,this.width=n.width,this.height=n.height):"center"===this.verticalAlign&&("left"===this.horizontalAlign?(b=d.x1+2,c=d.y2-2-(this.maxWidth/2-n.width/2),f=-90,k="left",this.width=n.height,this.height=n.width):
"right"===this.horizontalAlign?(b=d.x2-2,c=d.y1+2+(this.maxWidth/2-n.width/2),f=90,k="right",this.width=n.height,this.height=n.width):"center"===this.horizontalAlign&&(c=a.y1+(a.height/2-n.height/2),b=a.x1+(a.width/2-n.width/2),k="center",this.width=n.width,this.height=n.height),l="center");g.x=b;g.y=c;g.angle=f;g.horizontalAlign=l;g.render(!0);a.layoutManager.registerSpace(k,{width:this.width+("left"===k||"right"===k?this.margin+2:0),height:this.height+("top"===k||"bottom"===k?this.margin+2:0)});
this.bounds={x1:b,y1:c,x2:b+this.width,y2:c+this.height};this.ctx.textBaseline="top"}};U(va,M);va.prototype.render=ma.prototype.render;U(wa,M);wa.prototype.render=function(){var a=this.dockInsidePlotArea?this.chart.plotArea:this.chart,d=a.layoutManager.getFreeSpace(),b=null,c=0,f=0,g=0,h=0,l=this.markerMargin=this.chart.options.legend&&!x(this.chart.options.legend.markerMargin)?this.chart.options.legend.markerMargin:0.3*this.fontSize;this.height=0;var k=[],n=[];"top"===this.verticalAlign||"bottom"===
this.verticalAlign?(this.orientation="horizontal",b=this.verticalAlign,g=this.maxWidth=null!==this.maxWidth?this.maxWidth:d.width,h=this.maxHeight=null!==this.maxHeight?this.maxHeight:0.5*d.height):"center"===this.verticalAlign&&(this.orientation="vertical",b=this.horizontalAlign,g=this.maxWidth=null!==this.maxWidth?this.maxWidth:0.5*d.width,h=this.maxHeight=null!==this.maxHeight?this.maxHeight:d.height);for(var m=0;m<this.dataSeries.length;m++){var p=this.dataSeries[m];if("pie"!==p.type&&"doughnut"!==
p.type&&"funnel"!==p.type){var e=p.legendMarkerType=p.legendMarkerType?p.legendMarkerType:"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type&&"scatter"!==p.type&&"bubble"!==p.type||!p.markerType?$.getDefaultLegendMarker(p.type):p.markerType,q=p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:null}):p.name,r=p.legendMarkerColor=p.legendMarkerColor?p.legendMarkerColor:p.markerColor?p.markerColor:p._colorSet[0],s=
p.markerSize||"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type?0.75*this.lineHeight:0,v=p.legendMarkerBorderColor?p.legendMarkerBorderColor:p.markerBorderColor,w=p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:p.markerBorderThickness?Math.max(1,Math.round(0.2*s)):0,q=this.chart.replaceKeywordsWithValue(q,p.dataPoints[0],p,m),e={markerType:e,markerColor:r,text:q,textBlock:null,chartType:p.type,markerSize:s,lineColor:p._colorSet[0],dataSeriesIndex:p.index,dataPointIndex:null,markerBorderColor:v,
markerBorderThickness:w};k.push(e)}else for(var u=0;u<p.dataPoints.length;u++){var t=p.dataPoints[u],e=t.legendMarkerType?t.legendMarkerType:p.legendMarkerType?p.legendMarkerType:$.getDefaultLegendMarker(p.type),q=t.legendText?t.legendText:p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:t}):t.name?t.name:"DataPoint: "+(u+1),r=t.legendMarkerColor?t.legendMarkerColor:p.legendMarkerColor?p.legendMarkerColor:t.color?
t.color:p.color?p.color:p._colorSet[u%p._colorSet.length],s=0.75*this.lineHeight,v=t.legendMarkerBorderColor?t.legendMarkerBorderColor:p.legendMarkerBorderColor?p.legendMarkerBorderColor:t.markerBorderColor?t.markerBorderColor:p.markerBorderColor,w=t.legendMarkerBorderThickness?t.legendMarkerBorderThickness:p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:t.markerBorderThickness||p.markerBorderThickness?Math.max(1,Math.round(0.2*s)):0,q=this.chart.replaceKeywordsWithValue(q,t,p,u),e={markerType:e,
markerColor:r,text:q,textBlock:null,chartType:p.type,markerSize:s,dataSeriesIndex:m,dataPointIndex:u,markerBorderColor:v,markerBorderThickness:w};(t.showInLegend||p.showInLegend&&!1!==t.showInLegend)&&k.push(e)}}!0===this.reversed&&k.reverse();if(0<k.length){p=null;r=u=q=t=0;q=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,g):this.itemMaxWidth=Math.min(this.itemWidth,g):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,g):this.itemMaxWidth=g;s=0===s?0.75*
this.lineHeight:s;q-=s+l;for(m=0;m<k.length;m++){e=k[m];if("line"===e.chartType||"spline"===e.chartType||"stepLine"===e.chartType)q-=2*0.1*this.lineHeight;if(!(0>=h||"undefined"===typeof h||0>=q||"undefined"===typeof q)){if("horizontal"===this.orientation){e.textBlock=new W(this.ctx,{x:0,y:0,maxWidth:q,maxHeight:this.itemWrap?h:this.lineHeight,angle:0,text:e.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,
textBaseline:"middle"});e.textBlock.measureText();null!==this.itemWidth&&(e.textBlock.width=this.itemWidth-(s+l+("line"===e.chartType||"spline"===e.chartType||"stepLine"===e.chartType?2*0.1*this.lineHeight:0)));if(!p||p.width+Math.round(e.textBlock.width+s+l+(0===p.width?0:this.horizontalSpacing)+("line"===e.chartType||"spline"===e.chartType||"stepLine"===e.chartType?2*0.1*this.lineHeight:0))>g)p={items:[],width:0},n.push(p),this.height+=u,u=0;u=Math.max(u,e.textBlock.height)}else e.textBlock=new W(this.ctx,
{x:0,y:0,maxWidth:q,maxHeight:!0===this.itemWrap?h:1.5*this.fontSize,angle:0,text:e.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"middle"}),e.textBlock.measureText(),null!==this.itemWidth&&(e.textBlock.width=this.itemWidth-(s+l+("line"===e.chartType||"spline"===e.chartType||"stepLine"===e.chartType?2*0.1*this.lineHeight:0))),this.height<h-this.lineHeight?(p={items:[],width:0},
n.push(p)):(p=n[t],t=(t+1)%n.length),this.height+=e.textBlock.height;e.textBlock.x=p.width;e.textBlock.y=0;p.width+=Math.round(e.textBlock.width+s+l+(0===p.width?0:this.horizontalSpacing)+("line"===e.chartType||"spline"===e.chartType||"stepLine"===e.chartType?2*0.1*this.lineHeight:0));p.items.push(e);this.width=Math.max(p.width,this.width);r=e.textBlock.width+(s+l+("line"===e.chartType||"spline"===e.chartType||"stepLine"===e.chartType?2*0.1*this.lineHeight:0))}}this.itemWidth=r;this.height=!1===this.itemWrap?
n.length*this.lineHeight:this.height+u;this.height=Math.min(h,this.height);this.width=Math.min(g,this.width)}"top"===this.verticalAlign?(f="left"===this.horizontalAlign?d.x1:"right"===this.horizontalAlign?d.x2-this.width:d.x1+d.width/2-this.width/2,c=d.y1):"center"===this.verticalAlign?(f="left"===this.horizontalAlign?d.x1:"right"===this.horizontalAlign?d.x2-this.width:d.x1+d.width/2-this.width/2,c=d.y1+d.height/2-this.height/2):"bottom"===this.verticalAlign&&(f="left"===this.horizontalAlign?d.x1:
"right"===this.horizontalAlign?d.x2-this.width:d.x1+d.width/2-this.width/2,c=d.y2-this.height);this.items=k;for(m=0;m<this.items.length;m++)e=k[m],e.id=++this.chart._eventManager.lastObjectId,this.chart._eventManager.objectMap[e.id]={id:e.id,objectType:"legendItem",legendItemIndex:m,dataSeriesIndex:e.dataSeriesIndex,dataPointIndex:e.dataPointIndex};(0<this.borderThickness&&this.borderColor||this.backgroundColor)&&this.ctx.roundRect(f,c,this.width,this.height,this.cornerRadius,this.borderThickness,
this.backgroundColor,this.borderColor);for(m=d=0;m<n.length;m++){p=n[m];for(t=u=0;t<p.items.length;t++){e=p.items[t];r=e.textBlock.x+f+(0===t?0.2*s:this.horizontalSpacing);v=c+d;q=r;this.chart.data[e.dataSeriesIndex].visible||(this.ctx.globalAlpha=0.5);this.ctx.save();this.ctx.beginPath();this.ctx.rect(f,c,g,Math.max(h-h%this.lineHeight,0));this.ctx.clip();if("line"===e.chartType||"stepLine"===e.chartType||"spline"===e.chartType)this.ctx.strokeStyle=e.lineColor,this.ctx.lineWidth=Math.ceil(this.lineHeight/
8),this.ctx.beginPath(),this.ctx.moveTo(r-0.1*this.lineHeight,v+this.lineHeight/2),this.ctx.lineTo(r+0.85*this.lineHeight,v+this.lineHeight/2),this.ctx.stroke(),q-=0.1*this.lineHeight;O.drawMarker(r+s/2,v+this.lineHeight/2,this.ctx,e.markerType,e.markerSize,e.markerColor,e.markerBorderColor,e.markerBorderThickness);e.textBlock.x=r+l+s;if("line"===e.chartType||"stepLine"===e.chartType||"spline"===e.chartType)e.textBlock.x+=0.1*this.lineHeight;e.textBlock.y=Math.round(v+this.lineHeight/2);e.textBlock.render(!0);
this.ctx.restore();u=0<t?Math.max(u,e.textBlock.height):e.textBlock.height;this.chart.data[e.dataSeriesIndex].visible||(this.ctx.globalAlpha=1);r=G(e.id);this.ghostCtx.fillStyle=r;this.ghostCtx.beginPath();this.ghostCtx.fillRect(q,e.textBlock.y-this.lineHeight/2,e.textBlock.x+e.textBlock.width-q,e.textBlock.height);e.x1=this.chart._eventManager.objectMap[e.id].x1=q;e.y1=this.chart._eventManager.objectMap[e.id].y1=e.textBlock.y-this.lineHeight/2;e.x2=this.chart._eventManager.objectMap[e.id].x2=e.textBlock.x+
e.textBlock.width;e.y2=this.chart._eventManager.objectMap[e.id].y2=e.textBlock.y+e.textBlock.height-this.lineHeight/2}d+=u}0<k.length&&a.layoutManager.registerSpace(b,{width:this.width+2+2,height:this.height+5+5});this.bounds={x1:f,y1:c,x2:f+this.width,y2:c+this.height}};U(Ca,M);Ca.prototype.render=function(){var a=this.chart.layoutManager.getFreeSpace();this.ctx.fillStyle="red";this.ctx.fillRect(a.x1,a.y1,a.x2,a.y2)};U($,M);$.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===
...
1)/m*Math.log(a/this.dataPoints[0].x)>>0,0),this.dataPoints.length):0):(m=this.dataPoints[this.dataPoints.length-1].x-this.dataPoints[0].x,m=0<m?Math.min(Math.max((this.dataPoints.length-1)/m*(a-this.dataPoints[0].x)>>0,0),this.dataPoints.length):0));for(;;){g=0<h?m+f:m-f;if(0<=g&&g<this.dataPoints.length){var c=this.dataPoints[g],p=this.axisX.logarithmic?c.x>a?c.x/a:a/c.x:Math.abs(c.x-a);p<b.distance&&(b.dataPoint=c,b.distance=p,b.index=g);c=p;c<=l?l=c:0<h?k++:n++;if(1E3<k&&1E3<n)break}else if(0>
m-f&&m+f>=this.dataPoints.length)break;-1===h?(f++,h=1):h=-1}return d||b.dataPoint.x!==a?d&&null!==b.dataPoint?b:null:b};$.prototype.getDataPointAtXY=function(a,d,b){if(!this.dataPoints||0===this.dataPoints.length||a<this.chart.plotArea.x1||a>this.chart.plotArea.x2||d<this.chart.plotArea.y1||d>this.chart.plotArea.y2)return null;b=b||!1;var c=[],f=0,g=0,h=1,l=!1,k=Infinity,n=0,m=0,p=0;"none"!==this.chart.plotInfo.axisPlacement&&(p=(this.chart.axisX[0]?this.chart.axisX[0]:this.chart.axisX2[0]).getXValueAt({x:a,
y:d}),this.axisX.logarithmic?(g=Math.log(this.dataPoints[this.dataPoints.length-1].x/this.dataPoints[0].x),p=1<g?Math.min(Math.max((this.dataPoints.length-1)/g*Math.log(p/this.dataPoints[0].x)>>0,0),this.dataPoints.length):0):(g=this.dataPoints[this.dataPoints.length-1].x-this.dataPoints[0].x,p=0<g?Math.min(Math.max((this.dataPoints.length-1)/g*(p-this.dataPoints[0].x)>>0,0),this.dataPoints.length):0));for(;;){g=0<h?p+f:p-f;if(0<=g&&g<this.dataPoints.length){var e=this.chart._eventManager.objectMap[this.dataPointIds[g]],
...
L("markerSize",q,this)||4,v=b?20:s,r=Math.sqrt(Math.pow(e.x1-a,2)+Math.pow(e.y1-d,2));r<=v&&c.push({dataPoint:q,dataPointIndex:g,dataSeries:this,distance:r});g=Math.abs(e.x1-a);g<=k?k=g:0<h?n++:m++;r<=s/2&&(l=!0);break;case "rangeArea":case "rangeSplineArea":s=L("markerSize",q,this)||4;v=b?20:s;r=Math.min(Math.sqrt(Math.pow(e.x1-a,2)+Math.pow(e.y1-d,2)),Math.sqrt(Math.pow(e.x1-a,2)+Math.pow(e.y2-d,2)));r<=v&&c.push({dataPoint:q,dataPointIndex:g,dataSeries:this,distance:r});g=Math.abs(e.x1-a);g<=k?
k=g:0<h?n++:m++;r<=s/2&&(l=!0);break;case "bubble":s=e.size;r=Math.sqrt(Math.pow(e.x1-a,2)+Math.pow(e.y1-d,2));r<=s/2&&(c.push({dataPoint:q,dataPointIndex:g,dataSeries:this,distance:r}),l=!0);break;case "pie":case "doughnut":s=e.center;v="doughnut"===this.type?e.percentInnerRadius*e.radius:0;r=Math.sqrt(Math.pow(s.x-a,2)+Math.pow(s.y-d,2));r<e.radius&&r>v&&(r=Math.atan2(d-s.y,a-s.x),0>r&&(r+=2*Math.PI),r=Number(((180*(r/Math.PI)%360+360)%360).toFixed(12)),s=Number(((180*(e.startAngle/Math.PI)%360+
360)%360).toFixed(12)),v=Number(((180*(e.endAngle/Math.PI)%360+360)%360).toFixed(12)),0===v&&1<e.endAngle&&(v=360),s>=v&&0!==q.y&&(v+=360,r<s&&(r+=360)),r>s&&r<v&&(c.push({dataPoint:q,dataPointIndex:g,dataSeries:this,distance:0}),l=!0));break;case "candlestick":if(a>=e.x1-e.borderThickness/2&&a<=e.x2+e.borderThickness/2&&d>=e.y2-e.borderThickness/2&&d<=e.y3+e.borderThickness/2||Math.abs(e.x2-a+e.x1-a)<e.borderThickness&&d>=e.y1&&d<=e.y4)c.push({dataPoint:q,dataPointIndex:g,dataSeries:this,distance:Math.min(Math.abs(e.x1-
a),Math.abs(e.x2-a),Math.abs(e.y2-d),Math.abs(e.y3-d))}),l=!0;break;case "ohlc":if(Math.abs(e.x2-a+e.x1-a)<e.borderThickness&&d>=e.y2&&d<=e.y3||a>=e.x1&&a<=(e.x2+e.x1)/2&&d>=e.y1-e.borderThickness/2&&d<=e.y1+e.borderThickness/2||a>=(e.x1+e.x2)/2&&a<=e.x2&&d>=e.y4-e.borderThickness/2&&d<=e.y4+e.borderThickness/2)c.push({dataPoint:q,dataPointIndex:g,dataSeries:this,distance:Math.min(Math.abs(e.x1-a),Math.abs(e.x2-a),Math.abs(e.y2-d),Math.abs(e.y3-d))}),l=!0}if(l||1E3<n&&1E3<m)break}}else if(0>p-f&&
...
borderThickness:this.labelBorderThickness,cornerRadius:this.labelCornerRadius,maxHeight:h,angle:this.labelAngle,text:this.prefix+a+this.suffix,horizontalAlign:"left",fontSize:this.labelFontSize,fontFamily:this.labelFontFamily,fontWeight:this.labelFontWeight,fontColor:this.labelFontColor,fontStyle:this.labelFontStyle,textBaseline:"middle"}),this._labels.push({position:b.getTime(),textBlock:a,effectiveHeight:null});else{f=this.viewportMaximum;if(this.labels){a=Math.ceil(l);for(var l=Math.ceil(this.intervalStartPosition),
...
this._labels[c].textBlock;a.maxWidth=g;a.maxHeight=h;var q=a.measureText();n=q.height}f=[];p=l=0;if(this.labelAutoFit||this.options.labelAutoFit)if(x(this.labelAngle)||(this.labelAngle=(this.labelAngle%360+360)%360,90<this.labelAngle&&270>this.labelAngle?this.labelAngle-=180:270<=this.labelAngle&&360>=this.labelAngle&&(this.labelAngle-=360)),"bottom"===this._position||"top"===this._position)if(g=0.9*k>>0,p=0,!this.chart.panEnabled&&1<=this._labels.length){this.sessionVariables.labelFontSize=this.labelFontSize;
this.sessionVariables.labelMaxWidth=g;this.sessionVariables.labelMaxHeight=h;this.sessionVariables.labelAngle=this.labelAngle;this.sessionVariables.labelWrap=this.labelWrap;for(b=0;b<this._labels.length;b++){a=this._labels[b].textBlock;for(var r,s=a.text.split(" "),c=0;c<s.length;c++)e=s[c],this.ctx.font=a.fontStyle+" "+a.fontWeight+" "+a.fontSize+"px "+a.fontFamily,e=this.ctx.measureText(e),e.width>p&&(r=b,p=e.width)}b=0;for(b=this.intervalStartPosition<this.viewportMinimum?1:0;b<this._labels.length;b++)if(a=
...
0===this.labelAngle?h:Math.min((c-g*Math.cos(Math.PI/180*Math.abs(this.labelAngle)))/Math.sin(Math.PI/180*Math.abs(this.labelAngle)),c),s=(m-(n+a.fontSize/2)*Math.cos(Math.PI/180*Math.abs(-25)))/Math.sin(Math.PI/180*Math.abs(-25)),!x(this.options.labelWrap))this.labelWrap?x(this.options.labelMaxWidth)?(this.sessionVariables.labelMaxWidth=Math.min(Math.max(g,p),s),this.sessionVariables.labelWrap=this.labelWrap,q.width+d.width>>0>2*g&&(this.sessionVariables.labelAngle=-25)):(this.sessionVariables.labelWrap=
this.labelWrap,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelAngle=this.sessionVariables.labelMaxWidth>g?-25:this.sessionVariables.labelAngle):x(this.options.labelMaxWidth)?(this.sessionVariables.labelWrap=this.labelWrap,this.sessionVariables.labelMaxHeight=h,this.sessionVariables.labelMaxWidth=g,q.width+d.width>>0>2*g&&(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=s)):(this.sessionVariables.labelAngle=this.sessionVariables.labelMaxWidth>
...
h);else if(!x(d))if(c=q.width+d.width>>0,e=this.labelFontSize,p<g)c-2*g>l&&(l=c-2*g,c>=2*g&&c<2.2*g?(this.sessionVariables.labelMaxWidth=g,x(this.options.labelFontSize)&&12<e&&(e=Math.floor(12/13*e),a.measureText()),this.sessionVariables.labelFontSize=x(this.options.labelFontSize)?e:this.options.labelFontSize,this.sessionVariables.labelAngle=this.labelAngle):c>=2.2*g&&c<2.8*g?(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=s,this.sessionVariables.labelFontSize=e):c>=2.8*
...
this.sessionVariables.labelMaxWidth=Math.min(Math.max(g,p),s),d=d.measureText(),q.width+d.width>>0>2*g&&(this.sessionVariables.labelAngle=-25))}else(this.sessionVariables.labelAngle=this.labelAngle,this.sessionVariables.labelMaxHeight=0===this.labelAngle?h:Math.min((c-g*Math.cos(Math.PI/180*Math.abs(this.labelAngle)))/Math.sin(Math.PI/180*Math.abs(this.labelAngle)),c),s=0!=this.labelAngle?(m-(n+a.fontSize/2)*Math.cos(Math.PI/180*Math.abs(this.labelAngle)))/Math.sin(Math.PI/180*Math.abs(this.labelAngle)):
...
this.options.labelAngle)?x(this.options.labelWrap)?x(this.options.labelWrap)&&(x(this.options.labelMaxWidth)?x(d)||(k=q.height+d.height>>0,k-2*h>p&&(p=k-2*h,k>=2*h&&k<2.4*h?(x(this.options.labelFontSize)&&12<this.labelFontSize&&(this.labelFontSize=Math.floor(12/13*this.labelFontSize),a.measureText()),this.sessionVariables.labelMaxHeight=h,this.sessionVariables.labelFontSize=x(this.options.labelFontSize)?this.labelFontSize:this.options.labelFontSize):k>=2.4*h&&k<2.8*h?(this.sessionVariables.labelMaxHeight=
...
fontStyle:c[e].titleFontStyle,borderColor:c[e].titleBorderColor,borderThickness:c[e].titleBorderThickness,backgroundColor:c[e].titleBackgroundColor,cornerRadius:c[e].titleCornerRadius,textBaseline:"top"}));if("normal"===f){var v=[],w=[],u=[],t=[],H=[],I=[],M=[],K=[];if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&a[e].title&&(a[e]._titleTextBlock.maxWidth=a[e].titleMaxWidth||g.width,a[e]._titleTextBlock.maxHeight=a[e].titleWrap?0.8*g.height:1.5*a[e].titleFontSize,a[e]._titleTextBlock.angle=0);if(d&&
...
0)),V+=w[e],L+=d[e]?d[e].margin:0;else w.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateHeight():0));I.push(w);if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&(a[e].lineCoordinates.x1=h,a[e].lineCoordinates.x2=Math.round(g.x2-T-S>m.width-10?m.width-10:g.x2-T-S),a[e]._labels&&1<a[e]._labels.length&&(l=n=0,n=a[e]._labels[1],l="dateTime"===a[e].chart.plotInfo.axisXValueType?a[e]._labels[a[e]._labels.length-2]:a[e]._labels[a[e]._labels.length-1],r=n.textBlock.width*Math.cos(Math.PI/180*Math.abs(n.textBlock.angle))+
(n.textBlock.height-l.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(n.textBlock.angle)),s=l.textBlock.width*Math.cos(Math.PI/180*Math.abs(l.textBlock.angle))+(l.textBlock.height-l.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(l.textBlock.angle))),a[e]&&(a[e].labelAutoFit&&!x(z)&&!x(A))&&(l=0,0<a[e].labelAngle?A+s>k&&(l+=0<a[e].labelAngle?A+s-k-T:0):0>a[e].labelAngle?z-r<h&&z-r<a[e].viewportMinimum&&(B=h-(C+a[e].tickLength+u+z-r+a[e].labelFontSize/2)):0===a[e].labelAngle&&(A+s>k&&(l=A+
s/2-k-T),z-r<h&&z-r<a[e].viewportMinimum&&(B=h-C-a[e].tickLength-u-z+r/2)),a[e].viewportMaximum===a[e].maximum&&a[e].viewportMinimum===a[e].minimum&&0<a[e].labelAngle&&0<l?k-=l:a[e].viewportMaximum===a[e].maximum&&a[e].viewportMinimum===a[e].minimum&&0>a[e].labelAngle&&0<B?h+=B:a[e].viewportMaximum===a[e].maximum&&a[e].viewportMinimum===a[e].minimum&&0===a[e].labelAngle&&(0<B&&(h+=B),0<l&&(k-=l))),m.panEnabled?X=m.sessionVariables.axisX.height:m.sessionVariables.axisX.height=X,l=Math.round(g.y2-X-
f+N),n=Math.round(g.y2),a[e].lineCoordinates.x2=k,a[e].lineCoordinates.width=k-h,a[e].lineCoordinates.y1=l,a[e].lineCoordinates.y2=l,a[e].bounds={x1:h,y1:l,x2:k,y2:n-(X+f-v[e]-N),width:k-h,height:n-l}),N+=v[e]+a[e].margin;if(d&&0<d.length)for(e=0;e<d.length;e++)d[e].lineCoordinates.x1=Math.round(g.x1+U+C),d[e].lineCoordinates.x2=Math.round(g.x2-T-S>m.width-10?m.width-10:g.x2-T-S),d[e].lineCoordinates.width=Math.abs(k-h),d[e]._labels&&1<d[e]._labels.length&&(n=d[e]._labels[1],l="dateTime"===d[e].chart.plotInfo.axisXValueType?
d[e]._labels[d[e]._labels.length-2]:d[e]._labels[d[e]._labels.length-1],r=n.textBlock.width*Math.cos(Math.PI/180*Math.abs(n.textBlock.angle))+(n.textBlock.height-l.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(n.textBlock.angle)),s=l.textBlock.width*Math.cos(Math.PI/180*Math.abs(l.textBlock.angle))+(l.textBlock.height-l.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(l.textBlock.angle))),m.panEnabled?V=m.sessionVariables.axisX2.height:m.sessionVariables.axisX2.height=V,l=Math.round(g.y1),
n=Math.round(g.y2+d[e].margin),d[e].lineCoordinates.y1=l+V+L-Q,d[e].lineCoordinates.y2=l,d[e].bounds={x1:h,y1:l+(V+L-w[e]-Q),x2:k,y2:n,width:k-h,height:n-l},Q+=w[e]+d[e].margin;if(b&&0<b.length)for(e=0;e<b.length;e++)C=10,b[e]&&(h=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),C=b[e]._labels&&0<b[e]._labels.length?b[e]._labels[b[e]._labels.length-1].textBlock.height/2:10,l=Math.round(g.y1+V+L<Math.max(C,10)?Math.max(C,10):g.y1+V+L),k=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),
C=0<a.length?0:b[e]._labels[0].textBlock.height/2,n=Math.round(g.y2-X-f-C),b[e].lineCoordinates={x1:k-O,y1:l,x2:k-O,y2:n,height:Math.abs(n-l)},b[e].bounds={x1:h-(u[e]+O),y1:l,x2:k,y2:n,width:k-h,height:n-l},b[e].title&&(b[e]._titleTextBlock.maxWidth=0<b[e].titleMaxWidth&&b[e].titleMaxWidth<b[e].lineCoordinates.height?b[e].titleMaxWidth:b[e].lineCoordinates.height),O+=u[e]+b[e].margin);if(c&&0<c.length)for(e=0;e<c.length;e++)c[e]&&(h=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),
k=Math.round(h),C=c[e]._labels&&0<c[e]._labels.length?c[e]._labels[c[e]._labels.length-1].textBlock.height/2:0,l=Math.round(g.y1+V+L<Math.max(C,10)?Math.max(C,10):g.y1+V+L),C=0<a.length?0:c[e]._labels[0].textBlock.height/2,n=Math.round(g.y2-(X+f+C)),c[e].lineCoordinates={x1:h+P,y1:l,x2:h+P,y2:n,height:Math.abs(n-l)},c[e].bounds={x1:h,y1:l,x2:k+(t[e]+P),y2:n,width:k-h,height:n-l},c[e].title&&(c[e]._titleTextBlock.maxWidth=0<c[e].titleMaxWidth&&c[e].titleMaxWidth<c[e].lineCoordinates.height?c[e].titleMaxWidth:
...
if(c&&0<c.length)for(e=0;e<c.length;e++)c[e].calculateValueToPixelConversionParameters();if(0<q){if(a&&0<a.length)for(e=0;e<a.length;e++)E=H[q-1][e]===H[q][e]?!0:!1;else E=!0;if(d&&0<d.length)for(e=0;e<d.length;e++)F=I[q-1][e]===I[q][e]?!0:!1;else F=!0;if(b&&0<b.length)for(e=0;e<b.length;e++)G=M[q-1][e]===M[q][e]?!0:!1;else G=!0;if(c&&0<c.length)for(e=0;e<c.length;e++)J=K[q-1][e]===K[q][e]?!0:!1;else J=!0}if(E&&F&&G&&J)break;q++}p.save();p.beginPath();a[0]&&p.rect(5,a[0].bounds.y1,a[0].chart.width-
10,a[0].bounds.height);d[0]&&p.rect(5,d[d.length-1].bounds.y1,d[0].chart.width-10,d[0].bounds.height);p.clip();if(a&&0<a.length)for(e=0;e<a.length;e++)a[e].renderLabelsTicksAndTitle();if(d&&0<d.length)for(e=0;e<d.length;e++)d[e].renderLabelsTicksAndTitle();p.restore();if(b&&0<b.length)for(e=0;e<b.length;e++)b[e].renderLabelsTicksAndTitle();if(c&&0<c.length)for(e=0;e<c.length;e++)c[e].renderLabelsTicksAndTitle()}else{z=[];A=[];B=[];r=[];s=[];H=[];I=[];M=[];if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&
...
c[e].lineCoordinates.y1=n,c[e].lineCoordinates.y2=n,c[e].bounds={x1:h,y1:l+(c[e].margin+Q),x2:k,y2:n,width:k-h,height:U},c[e].title&&(c[e]._titleTextBlock.maxWidth=0<c[e].titleMaxWidth&&c[e].titleMaxWidth<c[e].lineCoordinates.width?c[e].titleMaxWidth:c[e].lineCoordinates.width),Q+=A[e]+c[e].margin);if(a&&0<a.length)for(e=0;e<a.length;e++){C=a[e]._labels&&0<a[e]._labels.length?a[e]._labels[0].textBlock.fontSize/2:0;h=Math.round(g.x1+f);l=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y2:g.y1<Math.max(C,
10)?Math.max(C,10):g.y1):g.y1<Math.max(C,10)?Math.max(C,10):g.y1;k=Math.round(g.x1+X+f);n=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y1:g.y2-P>m.height-Math.max(C,10)?m.height-Math.max(C,10):g.y2-P):g.y2>m.height-Math.max(C,10)?m.height-Math.max(C,10):g.y2;if(b&&0<b.length)for(C=0;C<b.length;C++)b[C]&&b[C].labelAutoFit&&(k=0>b[C].labelAngle?Math.max(k,v):0===b[C].labelAngle?Math.max(k,v/2):k,h=0>b[C].labelAngle||0===b[C].labelAngle?k-X:h);if(c&&0<c.length)for(C=0;C<c.length;C++)c[C]&&c[C].labelAutoFit&&
(k=c[C].lineCoordinates.x1,h=k-X);a[e].lineCoordinates={x1:k-K,y1:l,x2:k-K,y2:n,height:Math.abs(n-l)};a[e].bounds={x1:k-(B[e]+K),y1:l,x2:k,y2:n,width:k-h,height:n-l};a[e].title&&(a[e]._titleTextBlock.maxWidth=0<a[e].titleMaxWidth&&a[e].titleMaxWidth<a[e].lineCoordinates.height?a[e].titleMaxWidth:a[e].lineCoordinates.height);a[e].calculateValueToPixelConversionParameters();K+=B[e]+a[e].margin}if(d&&0<d.length)for(e=0;e<d.length;e++){C=d[e]._labels&&0<d[e]._labels.length?d[e]._labels[0].textBlock.fontSize/
...
this.lineThickness)),d=1===this.lineThickness%2?(this.lineCoordinates.x1<<0)+0.5:this.lineCoordinates.x1<<0,a.beginPath(),a.moveTo(d,this.lineCoordinates.y1),a.lineTo(d,this.lineCoordinates.y2),a.stroke());a.restore()};B.prototype.getPixelCoordinatesOnAxis=function(a){var d={};if("bottom"===this._position||"top"===this._position)d.x=this.convertValueToPixel(a),d.y=this.lineCoordinates.y1;if("left"===this._position||"right"===this._position)d.y=this.convertValueToPixel(a),d.x=this.lineCoordinates.x2;
return d};B.prototype.convertPixelToValue=function(a){if("undefined"===typeof a)return null;var d=0,d=0,d="number"===typeof a?a:"left"===this._position||"right"===this._position?a.y:a.x;return d=this.logarithmic?Math.pow(this.logarithmBase,(d-this.conversionParameters.reference)/this.conversionParameters.pixelPerUnit)*this.viewportMinimum:this.conversionParameters.minimum+(d-this.conversionParameters.reference)/this.conversionParameters.pixelPerUnit};B.prototype.convertValueToPixel=function(a){return this.logarithmic?
this.conversionParameters.reference+this.conversionParameters.pixelPerUnit*Math.log(a/this.conversionParameters.minimum)/this.conversionParameters.lnLogarithmBase+0.5<<0:this.conversionParameters.reference+this.conversionParameters.pixelPerUnit*(a-this.conversionParameters.minimum)+0.5<<0};B.prototype.setViewPortRange=function(a,d){this.sessionVariables.newViewportMinimum=this.viewportMinimum=Math.min(a,d);this.sessionVariables.newViewportMaximum=this.viewportMaximum=Math.max(a,d)};B.prototype.getXValueAt=
function(a){if(!a)return null;var d=null;"left"===this._position?d=this.convertPixelToValue(a.y):"bottom"===this._position&&(d=this.convertPixelToValue(a.x));return d};B.prototype.calculateValueToPixelConversionParameters=function(a){a={pixelPerUnit:null,minimum:null,reference:null};var d=this.lineCoordinates.width,b=this.lineCoordinates.height;a.minimum=this.viewportMinimum;if("bottom"===this._position||"top"===this._position)this.logarithmic?(a.lnLogarithmBase=Math.log(this.logarithmBase),a.pixelPerUnit=
...
"millisecond"):c/(1*E.secondDuration)<=a?(this.interval=1,this.intervalType="second"):c/(2*E.secondDuration)<=a?(this.interval=2,this.intervalType="second"):c/(5*E.secondDuration)<=a?(this.interval=5,this.intervalType="second"):c/(10*E.secondDuration)<=a?(this.interval=10,this.intervalType="second"):c/(15*E.secondDuration)<=a?(this.interval=15,this.intervalType="second"):c/(20*E.secondDuration)<=a?(this.interval=20,this.intervalType="second"):c/(30*E.secondDuration)<=a?(this.interval=30,this.intervalType=
"second"):c/(1*E.minuteDuration)<=a?(this.interval=1,this.intervalType="minute"):c/(2*E.minuteDuration)<=a?(this.interval=2,this.intervalType="minute"):c/(5*E.minuteDuration)<=a?(this.interval=5,this.intervalType="minute"):c/(10*E.minuteDuration)<=a?(this.interval=10,this.intervalType="minute"):c/(15*E.minuteDuration)<=a?(this.interval=15,this.intervalType="minute"):c/(20*E.minuteDuration)<=a?(this.interval=20,this.intervalType="minute"):c/(30*E.minuteDuration)<=a?(this.interval=30,this.intervalType=
"minute"):c/(1*E.hourDuration)<=a?(this.interval=1,this.intervalType="hour"):c/(2*E.hourDuration)<=a?(this.interval=2,this.intervalType="hour"):c/(3*E.hourDuration)<=a?(this.interval=3,this.intervalType="hour"):c/(6*E.hourDuration)<=a?(this.interval=6,this.intervalType="hour"):c/(1*E.dayDuration)<=a?(this.interval=1,this.intervalType="day"):c/(2*E.dayDuration)<=a?(this.interval=2,this.intervalType="day"):c/(4*E.dayDuration)<=a?(this.interval=4,this.intervalType="day"):c/(1*E.weekDuration)<=a?(this.interval=
1,this.intervalType="week"):c/(2*E.weekDuration)<=a?(this.interval=2,this.intervalType="week"):c/(3*E.weekDuration)<=a?(this.interval=3,this.intervalType="week"):c/(1*E.monthDuration)<=a?(this.interval=1,this.intervalType="month"):c/(2*E.monthDuration)<=a?(this.interval=2,this.intervalType="month"):c/(3*E.monthDuration)<=a?(this.interval=3,this.intervalType="month"):c/(6*E.monthDuration)<=a?(this.interval=6,this.intervalType="month"):(this.interval=c/(1*E.yearDuration)<=a?1:c/(2*E.yearDuration)<=
a?2:c/(4*E.yearDuration)<=a?4:Math.floor(B.getNiceNumber(c/(a-1),!0)/E.yearDuration),this.intervalType="year"));if(null===this.viewportMinimum||isNaN(this.viewportMinimum))this.viewportMinimum=f-h/2;if(null===this.viewportMaximum||isNaN(this.viewportMaximum))this.viewportMaximum=g+h/2;d?this.autoValueFormatString="MMM DD YYYY HH:mm":"year"===this.intervalType?this.autoValueFormatString="YYYY":"month"===this.intervalType?this.autoValueFormatString="MMM YYYY":"week"===this.intervalType?this.autoValueFormatString=
...
0<a.getMinutes()||0<a.getSeconds()||0<a.getMilliseconds())&&(a.setFullYear(a.getFullYear()+1),a.setMonth(0),a.setDate(1),a.setHours(0),a.setMinutes(0),a.setSeconds(0),a.setMilliseconds(0));return a};U(na,M);na.prototype.createUserOptions=function(a){if("undefined"!==typeof a||this.options._isPlaceholder){var d=0;this.parent.options._isPlaceholder&&this.parent.createUserOptions();this.options._isPlaceholder||(qa(this.parent.stripLines),d=this.parent.options.stripLines.indexOf(this.options));this.options=
"undefined"===typeof a?{}:a;this.parent.options.stripLines[d]=this.options}};na.prototype.render=function(){this.ctx.save();var a=this.parent.getPixelCoordinatesOnAxis(this.value),d=Math.abs("pixel"===this._thicknessType?this.thickness:this.parent.conversionParameters.pixelPerUnit*this.thickness);if(0<d){var b=null===this.opacity?1:this.opacity;this.ctx.strokeStyle=this.color;this.ctx.beginPath();var c=this.ctx.globalAlpha;this.ctx.globalAlpha=b;G(this.id);var f,g,h,l;this.ctx.lineWidth=d;this.ctx.setLineDash&&
this.ctx.setLineDash(I(this.lineDashType,d));if("bottom"===this.parent._position||"top"===this.parent._position)f=g=1===this.ctx.lineWidth%2?(a.x<<0)+0.5:a.x<<0,h=this.chart.plotArea.y1,l=this.chart.plotArea.y2,this.bounds={x1:f-d/2,y1:h,x2:g+d/2,y2:l};else if("left"===this.parent._position||"right"===this.parent._position)h=l=1===this.ctx.lineWidth%2?(a.y<<0)+0.5:a.y<<0,f=this.chart.plotArea.x1,g=this.chart.plotArea.x2,this.bounds={x1:f,y1:h-d/2,x2:g,y2:l+d/2};this.ctx.moveTo(f,h);this.ctx.lineTo(g,
l);this.ctx.stroke();this.ctx.globalAlpha=c}this.ctx.restore()};U(S,M);S.prototype._initialize=function(){if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class","canvasjs-chart-tooltip");this.container.style.position="absolute";this.container.style.height="auto";this.container.style.boxShadow="1px 1px 2px 2px rgba(0,0,0,0.1)";this.container.style.zIndex="1000";this.container.style.display="none";var a;a='<div style=" width: auto;height: auto;min-width: 50px;';
...
u?"rgba(255,255,255,.9)":"rgb(255,255,255)",this.borderColor=this.contentDiv.style.borderRightColor=this.contentDiv.style.borderLeftColor=this.contentDiv.style.borderColor=this.options.borderColor?this.options.borderColor:g[0].dataPoint.color?g[0].dataPoint.color:g[0].dataSeries.color?g[0].dataSeries.color:g[0].dataSeries._colorSet[g[0].index%g[0].dataSeries._colorSet.length],this.contentDiv.style.borderWidth=this.borderThickness||0===this.borderThickness?this.borderThickness+"px":"2px",this.contentDiv.style.borderRadius=
this.cornerRadius||0===this.cornerRadius?this.cornerRadius+"px":"5px",this.container.style.borderRadius=this.contentDiv.style.borderRadius,this.contentDiv.style.fontSize=this.fontSize||0===this.fontSize?this.fontSize+"px":"14px",this.contentDiv.style.color=this.fontColor?this.fontColor:"#000000",this.contentDiv.style.fontFamily=this.fontFamily?this.fontFamily:"Calibri, Arial, Georgia, serif;",this.contentDiv.style.fontWeight=this.fontWeight?this.fontWeight:"normal",this.contentDiv.style.fontStyle=
this.fontStyle?this.fontStyle:u?"italic":"normal"}catch(n){}"pie"===g[0].dataSeries.type||"doughnut"===g[0].dataSeries.type||"funnel"===g[0].dataSeries.type||"bar"===g[0].dataSeries.type||"rangeBar"===g[0].dataSeries.type||"stackedBar"===g[0].dataSeries.type||"stackedBar100"===g[0].dataSeries.type?a=a-10-this.container.clientWidth:(a=g[0].dataSeries.axisX.convertValueToPixel(g[0].dataPoint.x)-this.container.clientWidth<<0,a-=10);0>a&&(a+=this.container.clientWidth+20);a+this.container.clientWidth>
...
0,b=d.x.getTime?d.x.getTime():d.x,b in a.plotUnit.yTotals&&(c=a.plotUnit.yTotals[b],f=isNaN(d.y)?0:0===c?0:100*(d.y/c));else if("pie"===a.type||"doughnut"===a.type){for(i=c=0;i<a.dataPoints.length;i++)isNaN(a.dataPoints[i].y)||(c+=a.dataPoints[i].y);f=isNaN(d.y)?0:100*(d.y/c)}return{percent:f,total:c}};A.prototype.replaceKeywordsWithValue=function(a,d,b,c,f){var g=this;f="undefined"===typeof f?0:f;if((0<=b.type.indexOf("stacked")||"pie"===b.type||"doughnut"===b.type)&&(0<=a.indexOf("#percent")||0<=
...
[];this.previousDataPointEventObject=null;this.eventObjects=[];u&&(this.ghostCtx.clearRect(0,0,this.chart.width,this.chart.height),this.ghostCtx.beginPath())};la.prototype.getNewObjectTrackingId=function(){return++this.lastObjectId};la.prototype.mouseEventHandler=function(a){if("mousemove"===a.type||"click"===a.type){var d=[],b=xa(a),c=null;if((c=this.chart.getObjectAtXY(b.x,b.y,!1))&&"undefined"!==typeof this.objectMap[c])if(c=this.objectMap[c],"dataPoint"===c.objectType){var f=this.chart.data[c.dataSeriesIndex],
